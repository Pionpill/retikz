...
- **introduction 页 stale**（cross-review P3）：`plot/introduction` zh/en「当前能力」`ComponentAlert` 仍写 v0.1 alpha.2、只 line·point·cartesian、bar·polar「后续版本」；alpha.4 已落 bar / polar / sector / area。收尾时同步 zh + en 到当前能力
- *（后续追加……）*
