...
- 状态：Accepted
- 决策日期：2026-06-08
- 关联：[plot v0.1-alpha.9 roadmap](./roadmap.md) · [plot-design §3.5 CoordinateSystem](../../../../../architecture/plot-design.md) · 依赖：[ADR-01](./01-coordinate-frame-roles.md) / [ADR-02](./02-cartesian1d.md) / [ADR-03](./03-ternary2d.md)（IR + lowering 全就位）· 前身：[alpha.4 ADR-05 bindings-dsl](../v0.1-alpha.4/05-bindings-dsl.md)
...
> 🔖 本文件压缩前完整施工蓝图 = `git show 329fb8b7:notes/decisions/plot/v0/v0.1/v0.1-alpha.9/04-dsl-docs.md`（封板全文）。
