...
> 关联：[`plot v0.1 roadmap`](../roadmap.md) · [`plot v0 roadmap`](../../roadmap.md) · [`plot-design.md §3.3 transform / §3.4 scale / §3.6 encoding / §3.7 mark / §3.8 relation`](../../../../../architecture/plot-design.md) · [`_template.md`](../../../_template.md) · 上个 milestone：[`v0.1-alpha.2`](../alpha.2/roadmap.md)
