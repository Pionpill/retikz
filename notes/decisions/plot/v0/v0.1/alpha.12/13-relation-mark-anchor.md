...
- docs: 新增 `/plot/grammar/mark/relation`，更新 mark index、point/path/interval/custom 页面说明 anchorId；明确 `LinkMark` 方向被本 ADR 取代。
...
- `notes/decisions/plot/v0/v0.1/alpha.12/13-relation-mark-anchor.md`
- `notes/decisions/plot/v0/v0.1/alpha.12/roadmap.md`
- `notes/decisions/plot/v0/v0.1/alpha.12/03-mark-abstraction-registry.md` / `04-mark-surface-convergence.md` only for superseded LinkMark notes
