...
- 非矩形包络 anchor（圆形 / polar 面板连线落真实边界）依赖 core「scope 多态 bounding shape」（[core v0.4 文档](../../../../core/v0/v0.4/alpha.2/02-scope-polymorphic-bbox.md)），**非 MVP 阻塞**，本轮先矩形 bbox。
...
- **② plotArea anchor = 外部可见帧内的精确矩形 carrier**；非矩形包络依赖 core「scope 多态 bounding shape」（[core v0.4](../../../../core/v0/v0.4/alpha.2/02-scope-polymorphic-bbox.md)），非 MVP。见 L1-b。
...
- **core「scope 多态 bounding shape」**（非矩形包络 anchor）：独立 [core v0.4 文档](../../../../core/v0/v0.4/alpha.2/02-scope-polymorphic-bbox.md)，本 ADR MVP 只用矩形 bbox。
