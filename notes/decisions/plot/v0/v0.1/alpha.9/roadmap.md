...
- **histogram / bin transform** → alpha.12 Statistics（cartesian1D 只出空间底座，分箱是 transform 职责）
...
- 更多 mark / transform / stat → alpha.11+
