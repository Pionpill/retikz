...
- 状态：Accepted（已实现）
- 决策日期：2026-05-21
- 关联：[v0 roadmap §Shape Registry 提案](../../roadmap.md#shape-registry-提案) · [core-design.md §1.2 AI 一等公民](../../../../../architecture/core-design.md) · [alpha.1 ADR-02 nodeIndex/anchor 解析](../alpha.1/02-node-index-anchor-resolution.md) · [v0.1-beta.1 ADR-03 geometry 共享 transform / 死 anchor 清理](../../v0.1/beta.1/03-geometry-shared-transform-dead-anchor-cleanup.md) · [v0.1-beta.1 ADR-08 onWarn 收集器](../../v0.1/beta.1/08-compile-on-warn-collector.md)
...
> 🔖 封板压缩 commit `41326097`；压缩前完整施工蓝图 = `git show 41326097^:notes/decisions/core/v0/v0.2/alpha.3/01-shape-registry.md`。
