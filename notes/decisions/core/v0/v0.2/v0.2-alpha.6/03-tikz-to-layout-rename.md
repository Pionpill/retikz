...
- 状态：Accepted（已实现）
- 决策日期：2026-05-23
- 关联：[v0.2-alpha.6 plan §第二部分](./roadmap.md) · [v0.1-beta.2 ADR-02 `<TikZ>` 组件化](../../v0.1/v0.1-beta.2/02-tikz-to-tikz-component.md) · 本 milestone [ADR-01](./01-structured-target-anchor.md)（同窗口 system prompt / 白名单同步）
