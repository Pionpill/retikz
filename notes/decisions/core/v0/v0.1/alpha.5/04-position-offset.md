...
- 状态：Accepted（已实现）
- 决策日期：2026-05-12
- 关联：[v0 roadmap §v0.1.0-alpha.5](../../roadmap.md) · [core-design.md §4.5](../../../../../architecture/core-design.md) · [alpha.4 ADR-01](../alpha.4/01-node-at-positioning.md) · [alpha.4 ADR-02](../alpha.4/02-coordinate-placeholder.md)
...
> 🔖 封板压缩 commit `8a8f2f5a`；压缩前完整施工蓝图 = `git show 8a8f2f5a^:notes/decisions/core/v0/v0.1/alpha.5/04-position-offset.md`。
