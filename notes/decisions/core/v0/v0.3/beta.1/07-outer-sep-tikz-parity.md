...
- 关联：[v0.3-beta.1 roadmap](./roadmap.md) · **部分 supersede**：[v0.3-alpha.4 ADR-06 连接面](../alpha.4/06-connection-surface.md)（其「不在范围 §连接面影响 outer sep / 间距 → 另案」即本 ADR） · 参照：[core-design.md §7 AI 友好](../../../../architecture/core-design.md)
