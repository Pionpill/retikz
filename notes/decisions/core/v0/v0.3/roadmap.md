...
> **2026-06-06 顺延**：core shape 参数化泛化插入为 **v0.3-alpha.4**（见 [v0.3-alpha.4 roadmap](./v0.3-alpha.4/roadmap.md)），本节 A（时间轴动画）顺延为 **v0.3-alpha.5**。
...
| 子版本         | 主题                | 内容                                                                                                                                                                                                                                    | 依赖 / 待决策                                                                                    |
| -------------- | ------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------ |
| v0.3.0-alpha.4 | shape 参数化泛化 | `Node.shape` 从 Rect-only 升为「type + 自定义 params」可注册扩展（passthrough + 泛型 `ShapeDefinition<TParams>` + 编译期 `paramsSchema.parse`）；内置形状参数化：circle/ellipse、arc/sector、rectangle/polygon、star（`diamond` ≡ polygon 别名）。详见 [v0.3-alpha.4 roadmap](./v0.3-alpha.4/roadmap.md) | ADR-01 架构先行，02-05 各形状并发 |
