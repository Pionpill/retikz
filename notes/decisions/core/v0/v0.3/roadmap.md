...
| 子版本         | 主题                | 内容                                                                                                                                                                                                                                    | 依赖 / 待决策                                                                                    |
| -------------- | ------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------ |
| v0.3.0-alpha.2 | Vanilla Canvas 入口 | vanilla 的 Canvas 通路（`mountCanvas` / canvas 导出闭环），使两 renderer 都能从无框架 runtime 走（命令式 builder 已归 alpha.1 / ADR-04）                                                                                                | —                                                                                                |
...
| v0.3.0-alpha.4 | Plot 支撑能力       | 为 `@retikz/plot` 预留 lowering / 坐标化 / locator·anchor / layer·z-order / dataRef·scale 接入面；不在 core 实现 chart 本体                                                                                                             | 待决策 #7 / #8 / #9                                                                              |
| v0.3.0-beta.1  | 等价性与体验加固    | SVG / Canvas 对照测试、文档 demo、Node canvas / `@napi-rs` 导出、降级与诊断、包体与 public API 清理                                                                                                                                     | —                                                                                                |
