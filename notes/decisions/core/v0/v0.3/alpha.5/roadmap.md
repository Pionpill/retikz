...
> 关联：[`v0.3 roadmap §动画`](../roadmap.md)（A 时间轴动画转正本里程碑）· 前置复用：[`v0.3-alpha.3 水合`](../alpha.3/01-hydration.md)（rAF / 事件绑定 runtime 基建）· [`v0.3-alpha.4 ADR-08 meta`](../alpha.4/08-meta-provenance.md)（同款「IR 携带 → compile 沿 id-stamp 通路进 Scene」范式）
