...
| alpha.4          | Scene 视觉（shadow + blend；z-index 已落地）              | F                  | [ADR-01 shadow](./alpha.4/01-scene-drop-shadow.md) · [ADR-02 blend](./alpha.4/02-blend-mode.md)                                                            | Proposed / 实现契约齐 + 多 LLM 评审已合并（roadmap [alpha.4](./alpha.4/roadmap.md)；下「后续讨论结论 · F」） |
