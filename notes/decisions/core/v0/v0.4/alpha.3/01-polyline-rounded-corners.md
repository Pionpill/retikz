...
- 决策日期：2026-06-15
- 关联：[v0.4-alpha.3 roadmap](./roadmap.md) · [v0.4 roadmap 候选 B](../roadmap.md#b--路径补强2026-06-12-拍板) · [core-design.md §7 AI 一等公民](../../../../../architecture/core-design.md)
...
> 🔖 本文件压缩前完整施工蓝图 = `git show fd0a8598:notes/decisions/core/v0/v0.4/alpha.3/01-polyline-rounded-corners.md`（封板全文）。
