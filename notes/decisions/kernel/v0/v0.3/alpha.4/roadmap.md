...
> 关联：[`v0.3 roadmap`](../roadmap.md) · [`v0 roadmap`](../../roadmap.md) · [`core-design.md §7 AI 友好`](../../../../architecture/core-design.md) · 范式参照：[`v0.3-alpha.2 ADR-01 Tier 2 支撑`](../alpha.2/01-tier2-support.md)（passthrough + 注册表）· 下游动机：[`plot v0.1-alpha.4`](../../../../graph/v0/v0.1/roadmap.md)（polar 扇形需可连接 sector）
