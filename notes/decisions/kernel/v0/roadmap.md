...
> 具体执行计划放在同目录 `v0.*.md`，设计决策放在 `notes/decisions/kernel/v0/`。
...
- v0.1 细节：`notes/decisions/kernel/v0/v0.1/roadmap.md` 与 `v0.1/*/roadmap.md`
- v0.2 细节：`notes/decisions/kernel/v0/v0.2/roadmap.md` 与 `v0.2/*/roadmap.md`
- v0.3 细节：`notes/decisions/kernel/v0/v0.3/roadmap.md` 与 `v0.3/*/roadmap.md`
- ADR：`notes/decisions/kernel/v0/`
