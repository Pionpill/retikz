...
- 决策日期：2026-06-15
- 发起方：plot（Tier 2），消费方需求见 [plot v0.1 roadmap alpha.11](../../../../graph/v0/v0.1/roadmap.md)
...
> 🔖 本文件压缩前完整施工蓝图 = `git show fd0a8598:notes/decisions/core/v0/v0.4/alpha.3/03-core-contour-shape.md`（封板全文）。
