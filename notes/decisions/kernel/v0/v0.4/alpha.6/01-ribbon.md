...
- `apps/docs/src/contents/kernel/components/draw/ribbon/index.zh.mdx`
- `apps/docs/src/contents/kernel/components/draw/ribbon/index.en.mdx`
...
| `apps/docs/src/contents/kernel/components/draw/ribbon/*` | 新增 | 中英文文档与 demo |
...
- `apps/docs/src/contents/kernel/components/draw/**`
- `apps/docs/src/data/**`
- `apps/docs/src/i18n/**`
- 对应测试文件
