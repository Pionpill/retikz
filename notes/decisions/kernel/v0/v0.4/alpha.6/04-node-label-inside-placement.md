...
- 决策日期：2026-06-26
- Owner：core
- 关联：[kernel v0.4-alpha.6 roadmap](./roadmap.md) · [graph alpha.13 ADR-07](../../../../graph/v0/v0.1/alpha.13/07-mark-label-surface.md)
...
> 🔄 本文件压缩前完整施工蓝图 = `git show a1afbddcd7f916acacc98a6bc4be9b49a7cb0f33:notes/decisions/kernel/v0/v0.4/alpha.6/04-node-label-inside-placement.md`（封板全文）。
