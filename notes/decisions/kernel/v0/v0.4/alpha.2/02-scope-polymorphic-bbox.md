...
> 🔖 本文件压缩前完整施工蓝图 = `git show 13765be7:notes/decisions/core/v0/v0.4/alpha.2/02-scope-polymorphic-bbox.md`（封板全文）。
