...
>
> 关联：[`v0.2 总计划 §六段 alpha 节奏`](../roadmap.md#六段-alpha-节奏) · [`v0 roadmap §Shape Registry 提案`](./roadmap.md#shape-registry-提案) · alpha.3 ADR（`notes/decisions/kernel/v0/v0.2/alpha.3/` 已起草：[ADR-01](.//01-shape-registry.md)）· [alpha.1 ADR-02 anchor 解析](../alpha.1/02-node-index-anchor-resolution.md)（anchor lookup 同方向）
...
已起草（`notes/decisions/kernel/v0/v0.2/alpha.3/`，状态 Proposed）：
