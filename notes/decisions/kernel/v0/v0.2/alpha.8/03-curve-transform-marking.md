...
- 状态：Accepted（已实现）
- 决策日期：2026-05-24
- 关联：[v0.2-alpha.8 plan §第三~五部分](./roadmap.md) · [tikz-gap-analysis §2 Path / §3 Step](../../../../../analysis/tikz-gap-analysis.md) · 本 milestone [ADR-01](./01-arrow-definition.md)（marking 复用 arrow marker）/ [ADR-02](./02-path-generator-definition.md) · [alpha.1 Scope transform](../alpha.1/)（路径变换复用）
...
> 🔖 封板压缩 commit `7141a9b0`；压缩前完整施工蓝图 = `git show 7141a9b0^:notes/decisions/core/v0/v0.2/alpha.8/03-curve-transform-marking.md`。
