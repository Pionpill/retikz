...
>
> 关联：[`v0.2 总计划 §alpha.9 设计预想`](../roadmap.md) · [`tikz-gap-analysis §5 定位 / §6 Scene`](../../../../../analysis/tikz-gap-analysis.md) · 前一段 [`v0.2-alpha.8.md`](../alpha.8/roadmap.md)
>
...
6. **全量验收 + ADR 落档**：三包测试全绿；ADR 集合（`notes/decisions/kernel/v0/v0.2/alpha.9/`）固化待定项。
...
开工前另起（`notes/decisions/kernel/v0/v0.2/alpha.9/`，编号到时定）：
