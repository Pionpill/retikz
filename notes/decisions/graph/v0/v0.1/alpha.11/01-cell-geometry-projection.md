...
- 状态：Accepted
- 决策日期：2026-06-16
- 关联：[plot v0.1 roadmap](../roadmap.md)「区间几何下沉」备注 · [alpha.11 roadmap](./roadmap.md) · [plot-design.md §8.3 mark 几何 × coordinate / §8.1 可连接性](../../../../../architecture/plot-design.md) · [core ADR：contour shape](../../../../kernel/v0/v0.4/alpha.3/03-core-contour-shape.md)（已实现）
