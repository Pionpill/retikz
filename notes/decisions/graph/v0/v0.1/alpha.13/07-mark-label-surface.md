...
- 决策日期：2026-06-28
- Owner：plot
- 关联：[plot v0.1-alpha.13 roadmap](./roadmap.md) · [kernel alpha.6 ADR-04](../../../../kernel/v0/v0.4/alpha.6/04-node-label-inside-placement.md) · [kernel alpha.6 ADR-05](../../../../kernel/v0/v0.4/alpha.6/05-ribbon-label.md)
...
- 保留 flat label props 进入 PlotSpec schema：结构化 label 才能完整承载 core label contract；旧 sugar 如存在也只能在 React adapter 内转换。
...
> 🔄 本文件压缩前完整施工蓝图 = `git show a1afbddcd7f916acacc98a6bc4be9b49a7cb0f33:notes/decisions/graph/v0/v0.1/alpha.13/07-mark-label-surface.md`（封板全文）。
