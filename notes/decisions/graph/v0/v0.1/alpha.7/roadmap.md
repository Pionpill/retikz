...
> 关联：[`plot v0.1 roadmap`](../roadmap.md) · [`plot v0 roadmap`](../../roadmap.md)（阶段二 alpha.7）· [`plot-design §3.3 Aesthetics / §3.4 Scale / §3.9 Guide`](../../../../../architecture/plot-design.md) · [`_template.md`](../../../_template.md) · 上个 milestone：[`v0.1-alpha.6`](../alpha.6/roadmap.md)
...
现状（alpha.1~6，见 [上轮调研](../alpha.6/roadmap.md) + 代码核验）：
