...
- Docs：`/graph/grammar/transform` 需要重写为统计代数视角；mark 文档需要展示 `select` / `summarize` / `relate` 在 mark-local transform 中的用法。
...
- `notes/decisions/graph/v0/v0.1/alpha.12/16-statistical-transform-algebra.md`
...
- `apps/docs/src/contents/graph/grammar/transform/**`
