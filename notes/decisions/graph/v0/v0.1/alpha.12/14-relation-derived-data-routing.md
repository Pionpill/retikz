...
状态：Accepted
决策日期：2026-06-26
关联：[plot v0.1-alpha.12 roadmap](./roadmap.md) · [ADR-06 transform registry](./06-transform-registry.md) · [ADR-13 RelationMark](./13-relation-mark-anchor.md) · [core Path step schema](../../../../../../packages/kernel/core/src/schemas/path/step.ts)
...
> 🔖 本文件压缩前完整施工蓝图 = `git show 20392fb1f39f0383e9d8f8a29f31850da99b8825:notes/decisions/graph/v0/v0.1/alpha.12/14-relation-derived-data-routing.md`（封板全文）。
