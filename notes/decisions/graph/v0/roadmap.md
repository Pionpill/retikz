...
> 具体执行计划放在同目录 `v0.*/roadmap.md`，设计决策放在 `notes/decisions/graph/`，里程碑详情以 [`plot-design.md §13`](../../../architecture/plot-design.md) 为准。
...
- ADR：`notes/decisions/graph/`
- core 路线与能力：[`core v0 roadmap`](../../kernel/v0/roadmap.md)
