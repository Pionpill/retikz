...
>
> 关联设计：[`能力完备性与模块边界`](./capability-design.md) · [`原子契约与组合设计`](./atomic-contract-design.md) · [`性能与增量运行时设计`](./performance-design.md) · [`alpha.2 roadmap`](../../packages/kernel/_notes/decisions/v0/v0.5/roadmap.md) · [`Foundation ADR-023`](../../packages/kernel/_notes/decisions/v0/v0.5/023-foundation-package.md) · [`Foundation Schema ADR-026`](../../packages/kernel/_notes/decisions/v0/v0.5/026-foundation-schema-primitives.md) · [`Contextual Color ADR-032`](../../packages/kernel/_notes/decisions/v0/v0.5/032-contextual-color-resolution.md)
