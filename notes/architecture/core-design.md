...
`@retikz/plot` 的底层语义预研见 [`plot-design.md`](../../packages/viz/_notes/architecture/plot-design.md)：plot 以坐标系为底座，chart type 只是 coordinate / scale / encoding / mark / guide 的 preset 组合，不作为核心抽象。
