...
4. **P3 高级特性**：decorations、intersections、任意小图形 marking（alpha.8 marking 首批仅 arrow）、double border、clip、`useasboundingbox`、完整 calc 表达式（单 path 整体变换、pattern 自定义 motif `PatternDefinition` 均已 alpha.8 ✅）。
