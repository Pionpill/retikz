...
> 具体执行计划放在同目录 `v0.*.md`，设计决策放在 `notes/adr/v0/`。
...
| v1+ | 领域包与更广生态 | plot / graph / flow / math / advanced shape packs、更多 renderer / adapter、工具链与编辑体验放到核心契约稳定之后。 |

## 参考来源

- v0.1 细节：`notes/plans/v0/v0.1-*.md`
- v0.2 细节：`notes/plans/v0/v0.2.md` 与 `v0.2-alpha.*.md`
- ADR：`notes/adr/v0/`
- TikZ gap 分析：`notes/analysis/2026-05-07-tikz-gap-analysis.md`
