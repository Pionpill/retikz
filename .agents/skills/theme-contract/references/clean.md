...
参考仓库采用 [PolyForm Noncommercial License 1.0.0](https://github.com/larashero3-dotcom/lieflat-charts/blob/main/LICENSE)。本文件 只抽象可复用的视觉原则，不复制其模板、catalog、源码、token 色值、图型工作流或资源；Retikz 的公开 Theme 契约与各 package owner 始终是实现真源。
