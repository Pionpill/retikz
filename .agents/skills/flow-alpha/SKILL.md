...
| 4 | 文档 | [`develop-document`](../develop-document/SKILL.md) | AI（衔接 docs-doc-write） | 双语 mdx + demo + API 表完整才进 5 |
...
- [`docs-doc-write`](../docs-doc-write/SKILL.md) 是 develop-document 的实现细节，本 SKILL 透过 stage 4 间接调
