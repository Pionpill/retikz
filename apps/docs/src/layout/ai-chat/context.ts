...
- 定位：\`/core/concepts/primitive-relations/position\` · \`/core/reference/schema/placement\`
...
- Positioning: \`/core/concepts/primitive-relations/position\` · \`/core/reference/schema/placement\`
- IR: \`/core/reference/schema/scene\` · \`.../entity\` · \`.../path\`
