...
export const PACKAGE_LABEL: Record<PackageId, Localized> = {
  ...
  '@retikz/inspect': { zh: '@retikz/inspect', en: '@retikz/inspect' },
  ...
  '@retikz/chart': { zh: '@retikz/chart', en: '@retikz/chart' },
  '@retikz/chart-react': { zh: '@retikz/chart-react', en: '@retikz/chart-react' },
  '@retikz/chart-vanilla': { zh: '@retikz/chart-vanilla', en: '@retikz/chart-vanilla' },
