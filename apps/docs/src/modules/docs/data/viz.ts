...
export const vizSection: Array<Section> = [
  ...
  },
  {
    ...
    pages: [
      ...
      {
        id: 'contract',
        label: 'viz.plotContract',
        children: [
          { id: 'plot', label: 'viz.plotContractPlot' },
          { id: 'encoding', label: 'viz.plotContractEncoding' },
          { id: 'transform', label: 'viz.plotContractTransform' },
          { id: 'mark', label: 'viz.plotContractMark' },
          { id: 'scale', label: 'viz.plotContractScale' },
          { id: 'coordinate', label: 'viz.plotContractCoordinate' },
          { id: 'guide', label: 'viz.plotContractGuide' },
          { id: 'layout', label: 'viz.plotContractLayout' },
          { id: 'layer', label: 'viz.plotContractLayer' },
          { id: 'theme', label: 'viz.plotContractTheme' },
        ],
        meta: {
          pageType: 'reference',
          audience: 'integrator',
