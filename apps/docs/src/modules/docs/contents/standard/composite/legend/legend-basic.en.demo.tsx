...
const Demo: FC = () => (
  ...
  >
    <Legend
      title={label('relation-title', 'Relationships')}
      padding={12}
      content={{
        ...
        sampleGap: 12,
        items: [
          { key: 'direct', sample: lineSample('direct-line'), label: label('direct-label', 'Direct') },
          {
            key: 'indirect',
            sample: lineSample('indirect-line', [7, 5]),
            label: label('indirect-label', 'Indirect'),
          },
          {
            key: 'reference',
            sample: lineSample('reference-line', [1, 5]),
            label: label('reference-label', 'Reference'),
          },
        ],
      }}
    />
