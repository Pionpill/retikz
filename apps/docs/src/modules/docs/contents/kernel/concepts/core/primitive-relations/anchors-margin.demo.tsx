...
const Demo: FC = () => (
  <Layout width={620} height={160}>
    ...
    <Node id="a1" position={[-270, -10]} padding={10} stroke="gray" dashPattern={[4, 3]}>
      a
    </Node>
    <Node id="b1" position={[-160, -10]} padding={10} stroke="gray" dashPattern={[4, 3]}>
      b
    </Node>
    <Draw way={['a1', 'b1']} stroke="currentColor" strokeWidth={2} />

    {/* margin：border 锚点（auto）整体外移，留出间隙 */}
    <Node id="a2" position={[-40, -10]} padding={10} margin={12} stroke="gray" dashPattern={[4, 3]}>
      a
    </Node>
    <Node id="b2" position={[70, -10]} padding={10} margin={12} stroke="gray" dashPattern={[4, 3]}>
      b
    </Node>
    ...
    <Node id="b3" position={[300, -10]} padding={10} margin={12} stroke="gray" dashPattern={[4, 3]}>
      b
    </Node>
    <Draw
      way={[
