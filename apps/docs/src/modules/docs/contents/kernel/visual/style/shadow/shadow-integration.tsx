...
import { integrationI18n } from './shadow-integration.i18n';
...
const IntegrationDemo: FC<IntegrationDemoProps> = props => {
  ...
  return (
    <Layout viewBox={{ x: -65, y: -65, width: 330, height: 155 }}>
      <Scope
        defaults={{
          node: { style: { fill: 'lightskyblue', shadow: 'lg' } },
          path: { style: { fill: 'lightskyblue', shadow: 'lg' } },
        }}
      >
        ...
        <Node position={[200, 0]} layout={{ minimumSize: 75 }} style={{ shadow: 'none' }}>
          {text.overridden}
        </Node>
      </Scope>
    </Layout>
