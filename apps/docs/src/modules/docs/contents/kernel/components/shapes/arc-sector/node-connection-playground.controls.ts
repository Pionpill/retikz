...
/** 开放弧与 Sector 节点连接 playground 使用的稳定字段 id */
      ...
      controls: [
        {
          ...
          defaultValue: 'sector',
          options: [
            { value: 'sector', label: '扇形 / 环楔' },
            { value: 'open-arc', label: '开放弧' },
          ],
        },
        {
          kind: 'range',
...
/** 开放弧与 Sector 节点连接 playground 的稳定状态、预设与 API 覆盖 */
export const previewControlContract = {
  ...
  presets: [
    { id: 'open-arc-auto', label: '开放弧自动贴边', values: { shape: 'open-arc', sourceAngle: 145, anchor: 'auto' } },
    ...
    { id: 'open-arc-end', label: '开放弧终点', values: { shape: 'open-arc', anchor: 'end' } },
  ],
