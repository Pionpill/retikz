...
const Demo: FC = () => (
  <Layout width={640} height={240} style={{ maxWidth: '100%', height: 'auto' }}>
    ...
    <Node id="B" position={[-155, -100]} minimumSize={{ width: 250, height: 40 }} stroke="gray" dashPattern={[4, 3]} />
    <Node id="A" position={[-155, -30]} minimumSize={{ width: 250, height: 60 }} stroke="gray" />
    <Node id="Y" position={[155, -100]} minimumSize={{ width: 250, height: 40 }} stroke="gray" dashPattern={[4, 3]} />
    <Node id="X" position={[155, -30]} minimumSize={{ width: 250, height: 60 }} stroke="gray" dashPattern={[4, 3]} />
    <Node id="root" position={[0, 55]} minimumSize={{ width: 560, height: 50 }} stroke="gray" />
