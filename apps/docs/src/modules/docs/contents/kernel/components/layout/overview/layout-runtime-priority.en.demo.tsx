...
const Demo: FC = () => (
  <Layout width={650} height={300} style={{ maxWidth: '100%', height: 'auto' }}>
    <Node
      ...
      cornerRadius={4}
    />
    <Node position={[-180, -122]} stroke="none" fill="none" padding={0} textColor="gray" font={{ size: 12 }}>
      Renderer (fallback only when missing)
    </Node>
    <Node
      id="renderer-prop"
      position={[-225, -88]}
    ...
    <Node
      ...
      cornerRadius={4}
    />
    <Node position={[-183, -34]} stroke="none" fill="none" padding={0} textColor="gray" font={{ size: 12 }}>
      Animation (host policy override)
    </Node>
    <Node
      id="snapshot-at"
      position={[-220, 0]}
