...
import { axisLineControlsI18n } from './axis-line.i18n';

/** Step 正交连接的中文属性面板 */
const createControls = (lang: Lang) => {
  const i18n = axisLineControlsI18n[lang];
  return definePreviewControls({
    presentation: 'panel',
    title: i18n.orthogonalConnections,
    sections: [
      {
...
/** 默认中文控件，用于推导控件值类型 */
export const axisLineControls = createControls('zh');
