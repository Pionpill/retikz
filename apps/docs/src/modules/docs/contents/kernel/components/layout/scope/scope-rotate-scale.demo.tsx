...
const Demo: FC = () => (
  <Layout width={600} height={200}>
    ...
    >
      ...
      <Node id="r2" position={[60, 0]}>
        2
      </Node>
      <Node id="r3" position={[120, 0]}>
        3
      </Node>
    ...
    <Scope
      transforms={[
        { kind: 'translate', x: 70, y: 0 },
        { kind: 'scale', x: 1.3 },
      ]}
    >
      <Node id="s1" position={[0, 0]}>
        1
      </Node>
      <Node id="s2" position={[60, 0]}>
        2
      </Node>
      <Node id="s3" position={[120, 0]}>
        3
      </Node>
