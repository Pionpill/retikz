...
const Demo: FC = () => (
  <Layout>
    ...
    <Node id="ta" position={[RA.x, 52]} {...TITLE} style={{ ...TITLE.style, font: FONT }}>
      web anchors + center
    </Node>
    ...
    <Node id="tb" position={[RB.x, 52]} {...TITLE} style={{ ...TITLE.style, font: FONT }}>
      angle / edge
    </Node>
    ...
    <Node id="ts" position={[STAR_C.x, 52]} {...TITLE} style={{ ...TITLE.style, font: FONT }}>
      star · tip-N
    </Node>
    ...
    <Node id="tsec" position={[SEC.x, 52]} {...TITLE} style={{ ...TITLE.style, font: FONT }}>
