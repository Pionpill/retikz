...
const Demo: FC = () => (
  <Layout width={640} height={230} style={{ maxWidth: '100%', height: 'auto' }}>
    <Node id="dsl" position={[-248, -64]} stroke="none" align="middle" lineHeight={16}>
      <Text font={{ size: 15, weight: 'bold' }}>React DSL</Text>
      <Text fill="gray" font={{ size: 12 }}>
        {'<PointMark x="gdp" />'}
      </Text>
    </Node>
    <Node id="spec" position={[-78, -64]} stroke="none" align="middle" lineHeight={16}>
      <Text font={{ size: 15, weight: 'bold' }}>PlotSpec</Text>
      <Text fill="gray" font={{ size: 12 }}>
        encoding.x = field
      </Text>
    </Node>
    <Node id="definition" position={[98, -64]} stroke="none" align="middle" lineHeight={16}>
      <Text font={{ size: 15, weight: 'bold' }}>Definition</Text>
      <Text fill="gray" font={{ size: 12 }}>
        kind / resolve / deliver
      </Text>
    </Node>
    <Node id="hub" position={[252, -64]} stroke="none" align="middle" lineHeight={16}>
    ...
    <Node id="model" position={[-220, 50]} stroke="none" align="middle" lineHeight={15}>
      <Text font={{ size: 13, weight: 'bold' }}>data model</Text>
      <Text fill="gray" font={{ size: 11 }}>
        field types
      </Text>
    </Node>
    <Node id="transform" position={[-94, 50]} stroke="none" align="middle" lineHeight={15}>
      <Text font={{ size: 13, weight: 'bold' }}>transform</Text>
      <Text fill="gray" font={{ size: 11 }}>
        group / order
      </Text>
    </Node>
    <Node id="scale" position={[32, 50]} stroke="none" align="middle" lineHeight={15}>
      <Text font={{ size: 13, weight: 'bold' }}>scale</Text>
      <Text fill="gray" font={{ size: 11 }}>
        domain / range
      </Text>
    </Node>
    <Node id="coordinate" position={[158, 50]} stroke="none" align="middle" lineHeight={15}>
