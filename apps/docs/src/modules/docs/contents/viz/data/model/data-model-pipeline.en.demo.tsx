...
const Demo: FC = () => (
  <Layout width={720} height={180} style={{ maxWidth: '100%', height: 'auto' }}>
    <Node id="collect" position={[-265, -16]} stroke="none" align="middle" lineHeight={16}>
    ...
    <Node id="resolve" position={[85, -16]} stroke="none" align="middle" lineHeight={16}>
      <Text font={{ size: 15, weight: 'bold' }}>Resolve type</Text>
      <Text fill="gray" font={{ size: 12 }}>
        explicit / format / infer
      </Text>
    </Node>
    <Node id="meta" position={[255, -16]} stroke="none" align="middle" lineHeight={16}>
    ...
    <Node id="note" position={[255, 72]} stroke="none" align="middle">
      <Text fill="gray" font={{ size: 12 }}>
