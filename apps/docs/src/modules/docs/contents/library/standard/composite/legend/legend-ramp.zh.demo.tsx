...
const Demo: FC = () => (
  ...
  >
    <Legend kind={LegendContentKind.Ramp} direction={LegendDirection.Horizontal} padding={12} sampleGap={8}>
      <LegendTitle>
        <Node id="temperature-title" position={[0, 0]} text="温度" style={{ stroke: 'none' }} />
      </LegendTitle>
      <LegendRamp>
        <Node
          id="temperature-ramp"
          ...
          layout={{ minimumSize: { width: 160, height: 16 }, padding: 0 }}
        />
      </LegendRamp>
      <LegendTick tickKey="low" offset={0}>
        <Node id="low-label" position={[0, 0]} text="低" style={{ stroke: 'none' }} />
      </LegendTick>
      <LegendTick tickKey="middle" offset={0.5}>
        <Node id="middle-label" position={[0, 0]} text="中" style={{ stroke: 'none' }} />
      </LegendTick>
      <LegendTick tickKey="high" offset={1}>
        <Node id="high-label" position={[0, 0]} text="高" style={{ stroke: 'none' }} />
      </LegendTick>
    </Legend>
  </Layout>
);
