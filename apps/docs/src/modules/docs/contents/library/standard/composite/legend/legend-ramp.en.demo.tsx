  ...
  >
    <Legend kind={LegendContentKind.Ramp} direction={LegendDirection.Horizontal} padding={12} sampleGap={8}>
      ...
      <LegendTick tickKey="low" offset={0}>
        <Node id="low-label" position={[0, 0]} text="Low" style={{ stroke: 'none' }} />
      </LegendTick>
      <LegendTick tickKey="middle" offset={0.5}>
        <Node id="middle-label" position={[0, 0]} text="Mid" style={{ stroke: 'none' }} />
      </LegendTick>
      <LegendTick tickKey="high" offset={1}>
        <Node id="high-label" position={[0, 0]} text="High" style={{ stroke: 'none' }} />
      </LegendTick>
    </Legend>
  </Layout>
);
