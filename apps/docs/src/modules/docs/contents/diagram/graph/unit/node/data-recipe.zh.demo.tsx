...
/** 只存在于文档的 Data recipe，使用统一 GraphNode 与显式关系 */
const Demo: FC = () => (
  <Layout width={560} height={230}>
    <Scope transforms={[{ kind: 'translate', x: 32, y: 96 }]}>
      <GraphNode id="data-source" role="terminal" position={[0, 0]}>Source</GraphNode>
    </Scope>
    <Scope transforms={[{ kind: 'translate', x: 205, y: 96 }]}>
      <GraphNode id="data-clean" role="stage" position={[0, 0]}>Clean</GraphNode>
    </Scope>
    <Scope transforms={[{ kind: 'translate', x: 380, y: 96 }]}>
      <GraphNode id="data-valid" role="decision" position={[0, 0]}>Valid?</GraphNode>
    </Scope>
