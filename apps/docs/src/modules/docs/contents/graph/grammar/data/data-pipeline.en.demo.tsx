...
const Demo: FC = () => (
  <Layout width={640} height={180} style={{ maxWidth: '100%', height: 'auto' }}>
    <Node id="ext" position={[-245, -16]} stroke="none" align="center" lineHeight={16}>
      <Text font={{ size: 15, weight: 'bold' }}>External dataset</Text>
      <Text fill="gray" font={{ size: 12 }}>
        passed at runtime
      </Text>
    </Node>
    <Node id="layer" position={[-78, -16]} stroke="none" align="center" lineHeight={16}>
      <Text font={{ size: 15, weight: 'bold' }}>Data layer</Text>
      <Text fill="gray" font={{ size: 12 }}>
        model · normalize
      </Text>
    </Node>
    <Node id="channel" position={[92, -16]} stroke="none" align="center" lineHeight={16}>
      <Text font={{ size: 15, weight: 'bold' }}>Data channels</Text>
      <Text fill="gray" font={{ size: 12 }}>
        x / y / color / size
      </Text>
    </Node>
    <Node id="consume" position={[238, -16]} stroke="none" align="center" lineHeight={16}>
    ...
    <Node id="note" position={[-78, 70]} stroke="none" align="center">
      <Text fill="gray" font={{ size: 12 }}>
