...
const Demo: FC = () => (
  <FlowDiagram width={450} height="auto" style={{ maxWidth: '100%', height: 'auto' }}>
    <FlowLayout id="columns" direction="right" gap={56} align="start">
      <FlowGroup id="client" label="Client" layout={{ direction: 'down' }}>
        <FlowEntity id="interaction" text="User interaction" role="event" />
        <FlowEntity id="view" text="React View" role="state" />
      </FlowGroup>
      <FlowGroup id="server" label="Server">
