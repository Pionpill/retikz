...
const createScene = (values: typeof previewControlContract.canonicalValues): IRScene => ({
  ...
  children: [
    createGraph({
      ...
      children: [
        createEntity({ id: 'service', role: 'service', position: [-80, 0], text: '服务' }),
        createEntity({ id: 'stage', role: 'stage', position: [80, 0], text: '步骤' }),
      ],
    }),
  ],
});
...
/** Graph Theme selector 按有效 role 与 variant 覆盖 token */
