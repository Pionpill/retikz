...
import { entityDefinitionControls, previewControlContract } from './entity-definition.en.controls';

export const previewControls = entityDefinitionControls;

const serviceRole = defineEntityRole({
  role: 'service',
  description: 'A service subject that provides a stable interface',
  shape: 'rectangle',
  padding: { x: 14, y: 10 },
  cornerRadius: 10,
...
const gatewayKind = defineEntityKind({
  ...
  role: 'service',
  description: 'A service gateway facing external requests',
});
...
/** Shows the predicate schema, Source params, and appearance resolution loop through controls */
