...
const Demo: FC = () => (
  ...
  >
    <PointMark x="xOpacity" y="y" opacity="alpha" size={15} fill="#2563eb" stroke="#1e3a8a" strokeWidth={2} label="alpha" labelPosition="above" />
    <PointMark x="xFill" y="y" fillOpacity="alpha" size={15} fill="#16a34a" stroke="#14532d" strokeWidth={2} label="alpha" labelPosition="above" />
    <PointMark x="xDraw" y="y" drawOpacity="alpha" size={15} fill="#f97316" stroke="#7c2d12" strokeWidth={5} label="alpha" labelPosition="above" />
    <Axis dimension="x" />
