...
const Demo: FC = () => (
  <Layout width={320} height={140}>
    ...
    <Draw way={['a1', 'b1']} arrow="->" strokeWidth={2} />
    ...
    <Draw way={['a2', 'b2']} arrow="->" arrowDetail={{ scale: 1.5 }} strokeWidth={2} />
    ...
    <Draw way={['a3', 'b3']} arrow="->" arrowDetail={{ length: 14, width: 10 }} strokeWidth={2} />
  </Layout>
);
