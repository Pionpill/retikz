...
const Demo: FC = () => (
  <Layout width={340} height={180}>
    {/* 实心扇形拼饼图 */}
    <Sector center={[90, 90]} radius={72} startAngle={0} endAngle={120} fill="teal" stroke="white" strokeWidth={2} />
    ...
    <Sector center={[250, 90]} radius={72} innerRadius={20} startAngle={0} endAngle={120} fill="teal" stroke="white" strokeWidth={2} />
