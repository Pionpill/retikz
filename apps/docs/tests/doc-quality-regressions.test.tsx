...
import InspectCustomDemo from '../src/modules/docs/contents/kernel/packages/inspect/custom/inspect-custom.demo';
import { previewSource as RibbonGeometryPreviewSource } from '../src/modules/docs/contents/library/extension/ribbon/ribbon-geometry.demo';
