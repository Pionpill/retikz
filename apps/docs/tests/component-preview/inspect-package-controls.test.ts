...
import { previewControlContract as inspectSelectionContract } from '../../src/modules/docs/contents/kernel/packages/inspect/usage/inspect-selection.controls';
import { previewControlContract as inspectSelectionEnContract } from '../../src/modules/docs/contents/kernel/packages/inspect/usage/inspect-selection.en.controls';
