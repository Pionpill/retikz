...
import { previewControlContract as inspectSelectionContract } from '../../src/modules/docs/contents/kernel/packages/inspect/principles/inspect-selection.controls';
import { previewControlContract as inspectSelectionEnContract } from '../../src/modules/docs/contents/kernel/packages/inspect/principles/inspect-selection.en.controls';
