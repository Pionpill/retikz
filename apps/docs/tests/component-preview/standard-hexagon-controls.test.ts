...
import { previewControlContract as hexagonZh } from '@/modules/docs/contents/library/standard/shape/hexagon-example.controls';
import { previewSource } from '@/modules/docs/contents/library/standard/shape/hexagon-example.demo';
import { previewControlContract as hexagonEn } from '@/modules/docs/contents/library/standard/shape/hexagon-example.en.controls';
