...
import { previewControlContract as texPlaygroundContract } from '../../src/modules/docs/contents/kernel/packages/tex/authoring/tex-playground.controls';
import { previewControlContract as texPlaygroundEnContract } from '../../src/modules/docs/contents/kernel/packages/tex/authoring/tex-playground.en.controls';
