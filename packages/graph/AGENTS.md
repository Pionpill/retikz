...
| 包 | 职责 |
| --- | --- |
| `@retikz/plot` | Tier 2 GoG 可视化层：Plot IR、data / transform / scale / coordinate / mark / guide、plot lowering |
...
未来的 data / chart / table / geo 等边界只在 ADR 或 roadmap 明确后落包；AGENTS 不为未存在包保留详细规则。
