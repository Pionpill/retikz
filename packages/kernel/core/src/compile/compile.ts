...
import type { GroupPrim, Scene, ScenePrimitive, Transform } from '../contract/scene';
import type { ShapeDefinition } from '../contract/shape';
import type { ProviderCollection } from '../providers/registry';
import type { IR, IRAnimationTrack, IRChild, IRPathBase, IRPosition, IRTransform, ResolvedDropShadow } from '../schemas';
