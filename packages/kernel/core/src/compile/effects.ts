import type { IRDropShadow, ShadowPresetValue } from '../schemas/effects';
...
/**
 * 把 IR 的 shadow（预设字符串 | 对象 | undefined）展开成 renderer 只见的 canonical IRDropShadow
 ...
 */
export const resolveShadow = (shadow: ShadowPresetValue | IRDropShadow | undefined): IRDropShadow | undefined => {
  ...
  const merged: IRDropShadow = { ...(base ?? {}), ...explicit };
