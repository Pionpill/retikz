...
import { createCompileInvariantError, normalizeLayoutProbeError } from '../../src/compile/probe-failure';
...
import { isLayoutProbeRecoverableError } from '../../src/resolve/diagnostics';
