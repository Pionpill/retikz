...
describe('alignAngleSweep 一般中间跨度方向归一化', () => {
  it('CW 把负跨度翻成正向小弧', () => {
    const r = alignAngleSweep(350, 10, false);
  ...
  it('CCW 把正跨度翻成负向小弧', () => {
    const r = alignAngleSweep(10, 350, true);
