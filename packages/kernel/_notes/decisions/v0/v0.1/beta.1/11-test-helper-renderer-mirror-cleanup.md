...
- 状态：Accepted（已实现）
- 决策日期：2026-05-13
- 关联：[v0.1-beta.1 plan TODO-18](./roadmap.md) · [packages/kernel/AGENTS.md](../../../../../AGENTS.md)
...
> 🔖 封板压缩 commit `ea674f3f`；压缩前完整施工蓝图 = `git show ea674f3f^:_notes/decisions/core/v0/v0.1/beta.1/11-test-helper-renderer-mirror-cleanup.md`。
