...
- 状态：Accepted（已实现）
- 决策日期：2026-05-24
- 关联： · tikz-gap-analysis §5 定位（历史分析已删除） · [ADR-016 结构化 Target](./016-structured-target-anchor.md)（对象主契约 + target resolve）· [ADR-017 edgePoint](./017-side-t-edge-point.md)（`lerpPoint`）· 本 milestone [ADR-028](./028-clip.md) / [ADR-029](./029-viewbox-override.md)
...
- **clip**→ [ADR-028](./028-clip.md)；**viewBox override**→ [ADR-029](./029-viewbox-override.md)。
