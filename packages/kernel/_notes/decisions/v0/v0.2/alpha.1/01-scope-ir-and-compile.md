...
- 状态：Accepted（已实现）
- 决策日期：2026-05-16
- 关联：[v0 roadmap §v0.2 预备](../../roadmap.md) · [v0.2 总计划](../roadmap.md) · [v0.2-alpha.1 plan](./roadmap.md) · [alpha.5 ADR-01 (Scene 结构化)](../../v0.1/alpha.5/01-scene-primitive-structured.md)
...
> 🔖 封板压缩 commit `da448234`；压缩前完整施工蓝图 = `git show da448234^:_notes/decisions/core/v0/v0.2/alpha.1/01-scope-ir-and-compile.md`。
