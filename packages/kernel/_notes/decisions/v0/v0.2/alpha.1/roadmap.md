...
- 现 `apps/docs/src/contents/kernel/components/tikz/` 是叶子页（`index.{en,zh}.mdx` + 2 demo 直接平铺）
- alpha.1 落地时同步重构成组：
...
- mdx 文档 `apps/docs/src/contents/kernel/components/tikz/scope/index.{en,zh}.mdx` 新建（双语 + demo）
