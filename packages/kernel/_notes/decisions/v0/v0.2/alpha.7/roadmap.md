...
>
> 关联：[`v0.2 总计划 §alpha.7 设计预想`](../roadmap.md) · [`tikz-gap-analysis §1 Node`](../../../../../../../_notes/analysis/tikz-gap-analysis.md) · 后续段 [`v0.2-alpha.8.md`](../alpha.8/roadmap.md)（自定义 arrow 复用本段 Paint 颜色继承）
>
