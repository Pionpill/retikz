...
- 状态：Accepted（已实现）
- 决策日期：2026-05-23
- 关联：[v0.2-alpha.6 plan §第一部分](./roadmap.md) · [alpha.3 ADR-01 Shape Registry](../alpha.3/01-shape-registry.md)（anchor 接口先固化）· [alpha.1 ADR-02 nodeIndex/anchor 解析](../alpha.1/02-node-index-anchor-resolution.md) · 本 milestone [ADR-02](./02-side-t-edge-point.md) / [ADR-03](./03-tikz-to-layout-rename.md)
...
> 🔖 封板压缩 commit `e6db894b`；压缩前完整施工蓝图 = `git show e6db894b^:_notes/decisions/core/v0/v0.2/alpha.6/01-structured-target-anchor.md`。
