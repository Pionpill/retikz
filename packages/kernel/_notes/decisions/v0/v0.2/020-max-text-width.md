...
- 状态：Accepted（已实现）
- 决策日期：2026-05-24
- 关联： · tikz-gap-analysis §1 Node（历史分析已删除） · 本 milestone [ADR-019](./019-paint-basics.md) / [ADR-021](./021-pin.md)
...
- **Paint / 资源表** → [ADR-019](./019-paint-basics.md)；**pin** → [ADR-021](./021-pin.md)。
