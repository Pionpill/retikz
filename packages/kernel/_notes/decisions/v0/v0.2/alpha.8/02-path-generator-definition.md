...
- 状态：Accepted（已实现）
- 决策日期：2026-05-24
- 关联： · tikz-gap-analysis §3 Step（历史分析已删除） · [alpha.3 ADR-01 Shape Registry](../alpha.3/01-shape-registry.md)（注册面先例）· 本 milestone [ADR-01](./01-arrow-definition.md)（先实现）/ [ADR-03](./03-curve-transform-marking.md)
