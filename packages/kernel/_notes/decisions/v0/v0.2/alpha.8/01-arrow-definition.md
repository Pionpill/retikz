...
- 状态：Accepted（已实现）
- 决策日期：2026-05-24
- 关联： · tikz-gap-analysis §2 Path（历史分析已删除） · [alpha.3 ADR-01 Shape Registry](../alpha.3/01-shape-registry.md)（注册面先例）· [alpha.7 ADR-01 Paint](../alpha.7/01-paint-basics.md)（`PaintValue.contextStroke` 颜色继承）· 本 milestone [ADR-02](./02-path-generator-definition.md) / [ADR-03](./03-curve-transform-marking.md)
