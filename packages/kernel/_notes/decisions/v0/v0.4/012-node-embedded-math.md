...
- 决策日期：2026-06-16
- 关联：[ADR-011 tex](./011-tex-package-and-node-math.md) · [ADR-013 行内混排](./013-inline-math-runs.md)
...
- lowerTex 缺失或公式无效时沿 ADR-011/013 warning 降级，容器仍按普通节点处理，不使 renderer 崩溃
