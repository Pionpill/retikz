...
- 状态：Accepted
- 决策日期：2026-06-28
- 关联：[ADR-022](./022-provider-registry-contract.md) · [ADR-024](./024-capability-provider-migration.md)
...
Provider registry、错误消息和文档都使用上述 key 来源；不引入全局 namespace registry。重复、未知和实际迁移分别遵循 ADR-022、ADR-024
