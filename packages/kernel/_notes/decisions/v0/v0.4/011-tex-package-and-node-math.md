...
- 决策日期：2026-06-16
- 关联：[ADR-012 带框公式](./012-node-embedded-math.md) · [ADR-013 行内混排](./013-inline-math-runs.md)
...
core 已增加 lowerTex 注入点与诊断，tex 包和 React/Vanilla 透传已实现；公式公开模型由 ADR-013 的 text run 收敛。
