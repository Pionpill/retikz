...
- 决策日期：2026-06-16
- 关联：[v0.4-alpha.5 roadmap](./roadmap.md) · [ADR-01 tex 包](./01-tex-package-and-node-math.md) · [ADR-03 行内混排](./03-inline-math-runs.md) · `packages/kernel/core/src/compile/node.ts`
...
- `apps/docs/src/contents/kernel/packages/tex/tex-framed.demo.tsx`

> 压缩前完整施工蓝图：`git show 63220f823d012744b29551f0a4bf38ff269b0c7e:_notes/decisions/core/v0/v0.4/alpha.5/02-node-embedded-math.md`
