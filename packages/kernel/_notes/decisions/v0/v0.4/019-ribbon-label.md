...
- 状态：被 ADR-021 收敛
- 决策日期：2026-06-26
- 关联：[ADR-021](./021-path-kind-registry.md) · [plot ADR-079](../../../../../viz/_notes/decisions/plot/v0/v0.1/079-mark-label-surface.md)
...
ADR-021 将 Ribbon label 与 Path kind registry、共享 style/meta 和普通 Scene path 输出统一；不保留 `Ribbon.label` 独立入口或 sibling text 兼容语义
