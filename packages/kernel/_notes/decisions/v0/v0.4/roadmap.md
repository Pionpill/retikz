...
| 后续版本         | v0.5 / beta / long-term 候选拆分                          | 待定               | —                                                                                                                                                         | 待讨论：headless interaction / Progressive IR 可进入 v0.5 设计；交互和用户操作场景需要评估 incremental compile、IR diff、bailout 与 concurrent 调度；beta 聚焦 API 与安装验收；P3D / scope 富化等更长期处理 |
