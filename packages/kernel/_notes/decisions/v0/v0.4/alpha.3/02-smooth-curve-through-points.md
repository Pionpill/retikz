...
- 决策日期：2026-06-15
- 关联：[v0.4-alpha.3 roadmap](./roadmap.md) · [v0.4 roadmap 候选 B](../roadmap.md#b--路径补强2026-06-12-拍板) · [alpha.1 ADR-01 `@retikz/math`](../alpha.1/01-math-package-and-geometry-api.md)（`curve/` 子模块原「后置」，2026-06-15 人工拍板提前到本 milestone 开启）· `ir/path/step.ts`（`StepSchema`）· `path-generators/`（generator 机制）
...
> 🔖 本文件压缩前完整施工蓝图 = `git show fd0a8598:_notes/decisions/core/v0/v0.4/alpha.3/02-smooth-curve-through-points.md`（封板全文）。
