...
- 状态：Accepted
- 决策日期：2026-06-29
- 关联：[ADR-022](./022-provider-registry-contract.md) · [ADR-023](./023-provider-key-contract.md) · [ADR-024](./024-capability-provider-migration.md) · [ADR-025](./025-adapter-surface-and-docs.md)
