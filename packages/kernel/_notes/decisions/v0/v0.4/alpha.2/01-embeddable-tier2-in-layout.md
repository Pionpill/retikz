...
- 关联：[v0.4 路线讨论](../roadmap.md) · [plot v0.1-alpha.10 ADR-02 可被组合（首个消费方 / 硬依赖本文档）](../../../../../../graph/_notes/decisions/v0/v0.1/alpha.10/02-plot-composable.md) · [core v0.3-alpha.2 ADR-01 Tier2 支持（composite 展开机制）](../../v0.3/alpha.2/01-tier2-support.md) · [core-design.md §7 AI 一等公民](../../../../../../../notes/architecture/core-design.md) · [plot-design §7 多坐标组合](../../../../../../graph/notes/architecture/plot-design.md)
