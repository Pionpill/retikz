...
> 状态：`v0.5.0-alpha.1` 与 `v0.5.0-alpha.2` 已完成实现、测试、双语文档与 Accepted 收尾；alpha.3 已进入 Proposed 设计，承接 Concurrent + generation；alpha.4 仅登记 Headless Interaction 候选边界。
>
...
| 增量性能闭环              | 用 Diff、局部 compile 与 retained renderer 减少持续更新成本              | [alpha.2 Accepted](./alpha.2/roadmap.md)                                 |
