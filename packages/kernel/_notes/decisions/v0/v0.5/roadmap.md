...
> 状态：`v0.5.0-alpha.1` 已完成 Accepted 收尾；`v0.5.0-alpha.2` 的 ADR-01～10、ADR-12～15 已 Accepted，ADR-11 仍为 Proposed；alpha.3 已进入 Proposed 设计，承接 Concurrent + generation；alpha.4 仅登记 Headless Interaction 候选边界。
>
...
| 二维仿射矩阵原子          | 为 Render hydration 与 TeX SVG lowering 提供同一纯数值矩阵真源           | [alpha.2 ADR-15 Accepted](./alpha.2/15-affine-matrix-primitives.md)           |
...
| 版本    | 交付边界                                                                                                                | 上位设计                                                                                                                                                                              |
| ------- | ----------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| alpha.2 | `sync + atomic + incremental`；补齐 Standard Box Layout 所需双轴 child layout / replay contract 与跨包 Math affine 原子 | [性能设计](../../../../../../notes/architecture/performance-design.md) · [ADR-06](./alpha.2/06-box-layout-composite-contract.md) · [ADR-15](./alpha.2/15-affine-matrix-primitives.md) |
