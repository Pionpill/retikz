# ADR-06：Node 固定宽度与内容重排

- 状态：Accepted
- 决策日期：2026-09-12
- 关联：[alpha.4 roadmap](./roadmap.md) · [Child Layout Proposal、Probe 与 Alignment Guide 合同](../../alpha.2/08-layout-proposal-probe-contract.md) · [Drawing Complete](../../../../architecture/core-drawing-complete.md)
