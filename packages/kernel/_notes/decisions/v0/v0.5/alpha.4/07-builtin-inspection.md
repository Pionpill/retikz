# ADR-07：扩展 Core 元素观测与内置 Inspector

- 状态：Accepted
- 决策日期：2026-09-13
- 接受日期：2026-09-13
- 关联：[当前 roadmap](./roadmap.md) · [Inspector 独立包](../alpha.2/12-extensible-inspector-content.md) · [Drawing Complete](../../../../architecture/core-drawing-complete.md)
