...
- 决策日期：2026-07-26
- 接受日期：2026-07-28
- 关联：[ADR-007](./007-layout-aware-composite.md) · [ADR-017](./017-layout-proposal-probe-contract.md)
...
本 ADR 独立补全 Core 的通用 child-layout 合同，不依赖 ADR-014，也不扩大其它 alpha.2 ADR 的能力范围。Flex line breaking、Grid track sizing、free-space distribution、alignment 与领域 artifact 仍由各 Tier 2 owner 负责。
