...
- 状态：Accepted
- 决策日期：2026-06-07
- 关联：[ADR-017 动画 IR](./017-timeline-animation-ir.md) · [ADR-020 runtime 控制](./020-runtime-control.md)
...
通用 custom property 插值不属于 SVG 的内置映射；跨元素 sequence 和 runtime 共享时钟由 ADR-020 管理。
