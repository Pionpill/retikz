...
- 状态：Accepted
- 决策日期：2026-06-07
- 关联：[alpha.3 hydration](./008-hydration.md) · [ADR-017 动画 IR](./017-timeline-animation-ir.md) · [ADR-020 runtime 播放](./020-runtime-control.md) · [alpha.4 meta](./016-meta-provenance.md)
