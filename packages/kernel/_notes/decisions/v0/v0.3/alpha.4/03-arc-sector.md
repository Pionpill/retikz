...
- 状态：Accepted
- 决策日期：2026-06-06
- 关联：[v0.3-alpha.4 roadmap](./roadmap.md) · 依赖：[ADR-01 shape 参数化机制](./01-shape-params-generalization.md)（nested params + defineShape + 双护栏 + circumscribe 返回精确 AABB） · 下游：[plot v0.1-alpha.4](../../../../../../graph/_notes/decisions/v0/v0.1/roadmap.md)（polar bar→sector）· 文档页：`apps/docs/src/contents/kernel/components/shapes/arc-sector/`
...
> 🔖 本文件压缩前完整施工蓝图 = `git show 62562f1d:_notes/decisions/core/v0/v0.3/alpha.4/03-arc-sector.md`（封板全文）。
