...
> 🔖 本文件压缩前完整施工蓝图 = `git show 62562f1d:_notes/decisions/core/v0/v0.3/alpha.4/01-shape-params-generalization.md`（封板全文）。
