...
- 状态：Accepted
- 决策日期：2026-06-06
- 关联：[v0.3-alpha.4 roadmap](./roadmap.md) · 依赖：[ADR-01 shape 参数化机制](./01-shape-params-generalization.md)（nested params + defineShape + 双护栏 + circumscribe 精确 AABB） · 文档页：`apps/docs/src/contents/kernel/components/shapes/star/`
...
> 🔖 本文件压缩前完整施工蓝图 = `git show 62562f1d:_notes/decisions/core/v0/v0.3/alpha.4/05-star.md`（封板全文）。
