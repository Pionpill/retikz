...
- 状态：Accepted
- 决策日期：2026-06-09
- 关联：[`v0.3-beta.1 roadmap`](./roadmap.md) TODO-1 · **几何契约前置**：[v0.2-ADR-023 arrow 定义](../v0.2/023-arrow-definition.md)（`ArrowDefinition` / `BUILTIN_ARROWS` / `hollow` + `lineContactX` 静态 base 范式）· [v0.1-ADR-006 arrow detail](../v0.1/006-path-arrow-detail.md)（`fill` 在空心 shape 上 silent no-op）
