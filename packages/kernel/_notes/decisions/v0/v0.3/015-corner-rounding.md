...
- 状态：Accepted
- 决策日期：2026-06-06
- 关联：[ADR-012 rectangle/polygon](./012-rectangle-polygon.md) · [ADR-013 star](./013-star.md) · [ADR-011 arc/sector](./011-arc-sector.md) · [ADR-014 connection surface](./014-connection-surface.md)
