...
- 决策日期：2026-05-29
- 关联：[ADR-001 SVG descriptor](./001-svg-descriptor-contract.md) · [ADR-003 Vanilla runtime](./003-vanilla-runtime-and-dependency-graph.md) · [ADR-005 renderer 重打包](./005-renderer-repackage.md)
