...
- 状态：Accepted（已实现）
- 决策日期：2026-05-29
- 关联：[ADR-002 Canvas renderer](./002-canvas-renderer-and-react-canvas-mode.md) · [ADR-003 Vanilla runtime](./003-vanilla-runtime-and-dependency-graph.md) · [ADR-005 renderer 重打包](./005-renderer-repackage.md)
