...
> - 完整施工契约（Schema 改动表 / 文件 scope / 测试象限 16 case / 依赖现有元素）：`git show 9f795047:_notes/decisions/core/v0/v0.3/alpha.3/01-hydration.md`。

> 🔖 封板压缩 commit `a5a1bd80`；压缩前完整施工蓝图 = `git show a5a1bd80^:_notes/decisions/core/v0/v0.3/alpha.3/01-hydration.md`。
