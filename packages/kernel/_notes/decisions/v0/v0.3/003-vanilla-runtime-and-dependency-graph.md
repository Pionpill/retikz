...
- 决策日期：2026-05-31
- 关联：[ADR-001 SVG descriptor](./001-svg-descriptor-contract.md) · [ADR-002 Canvas renderer](./002-canvas-renderer-and-react-canvas-mode.md) · [ADR-005 renderer 重打包](./005-renderer-repackage.md)
