...
- [`decisions/v0/v0.5/roadmap.md`](./decisions/v0/v0.5/roadmap.md)：当前 v0.5 路线；alpha.1 已完成，alpha.2 / alpha.3 / alpha.4 分别承接增量性能、Concurrent + generation 与 Headless Interaction。
