...
- **拥有的契约**：既有类型、断言与错误契约，以及 `NonBlankStringSchema`、`PositiveNumberSchema`、`NonNegativeNumberSchema`、`PositiveIntegerSchema`、`NonNegativeIntegerSchema`、`NormalizedFractionSchema` 与 JSON-safe plain data 快照 helper
