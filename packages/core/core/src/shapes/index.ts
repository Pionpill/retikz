...
export const BUILTIN_SHAPES: Record<Exclude<BuiltinShapeName, 'circle' | 'diamond'> | 'sector' | 'arc' | 'polygon', ShapeDefinition> = {
  rectangle,
  ellipse,
  sector,
  arc,
...
export { rectangle, ellipse, polygon, sector, arc, defineShape };
