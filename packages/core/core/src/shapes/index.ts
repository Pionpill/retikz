...
export const BUILTIN_SHAPES: Record<Exclude<BuiltinShapeName, 'circle'> | 'sector' | 'arc' | 'polygon', ShapeDefinition> = {
  rectangle,
  ellipse,
  diamond,
  sector,
...
export { rectangle, ellipse, diamond, polygon, sector, arc, defineShape };
