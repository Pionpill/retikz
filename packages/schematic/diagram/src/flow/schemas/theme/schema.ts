...
export const FlowEntityStyleSchema = strictObject({
  ...
  align: EntitySchema.shape.layout.unwrap().shape.align,
  lineHeight: EntitySchema.shape.layout.unwrap().shape.lineHeight,
  maxTextWidth: EntitySchema.shape.layout.unwrap().shape.maxTextWidth,
  font: EntitySchema.shape.style.unwrap().shape.font,
})
...
export const FlowEntityLayoutSchema = strictObject({
  minimumSize: EntitySchema.shape.layout.unwrap().shape.minimumSize,
  margin: EntitySchema.shape.layout.unwrap().shape.margin,
})
...
export const FlowRelationStyleSchema = strictObject({
  ...
  dashPattern: RelationSchema.shape.style.unwrap().shape.dashPattern,
})
...
const tokenShape = {
  ...
  'flow.entity.color': NodeSchema.shape.style.unwrap().shape.color,
  'flow.entity.textColor': NodeSchema.shape.style.unwrap().shape.textColor,
  'flow.entity.fill': NodeSchema.shape.style.unwrap().shape.fill,
  'flow.entity.stroke': NodeSchema.shape.style.unwrap().shape.stroke,
  'flow.entity.fillOpacity': NodeSchema.shape.style.unwrap().shape.fillOpacity,
  'flow.entity.strokeWidth': NodeSchema.shape.style.unwrap().shape.strokeWidth,
  'flow.entity.strokeOpacity': NodeSchema.shape.style.unwrap().shape.strokeOpacity,
  'flow.entity.opacity': NodeSchema.shape.style.unwrap().shape.opacity,
  'flow.entity.shadow': NodeSchema.shape.style.unwrap().shape.shadow,
  'flow.entity.blendMode': NodeSchema.shape.style.unwrap().shape.blendMode,
  'flow.entity.dashed': NodeSchema.shape.style.unwrap().shape.dashed,
  'flow.entity.dotted': NodeSchema.shape.style.unwrap().shape.dotted,
  'flow.entity.dashPattern': NodeSchema.shape.style.unwrap().shape.dashPattern,
  'flow.entity.dashOffset': NodeSchema.shape.style.unwrap().shape.dashOffset,
  'flow.entity.align': NodeSchema.shape.layout.unwrap().shape.align,
  'flow.entity.lineHeight': NodeSchema.shape.layout.unwrap().shape.lineHeight,
  'flow.entity.maxTextWidth': NodeSchema.shape.layout.unwrap().shape.maxTextWidth,
  'flow.entity.font': NodeSchema.shape.style.unwrap().shape.font,
  'flow.entity.minimumSize': NodeSchema.shape.layout.unwrap().shape.minimumSize,
  'flow.entity.margin': NodeSchema.shape.layout.unwrap().shape.margin,
  ...
  'flow.relation.color': RelationSchema.shape.style.unwrap().shape.color,
  'flow.relation.stroke': RelationSchema.shape.style.unwrap().shape.stroke,
  'flow.relation.strokeWidth': RelationSchema.shape.style.unwrap().shape.strokeWidth,
  'flow.relation.strokeOpacity': RelationSchema.shape.style.unwrap().shape.strokeOpacity,
  'flow.relation.opacity': RelationSchema.shape.style.unwrap().shape.opacity,
  'flow.relation.shadow': RelationSchema.shape.style.unwrap().shape.shadow,
  'flow.relation.blendMode': RelationSchema.shape.style.unwrap().shape.blendMode,
  'flow.relation.lineCap': RelationSchema.shape.style.unwrap().shape.lineCap,
  'flow.relation.lineJoin': RelationSchema.shape.style.unwrap().shape.lineJoin,
  'flow.relation.dashPattern': RelationSchema.shape.style.unwrap().shape.dashPattern,
  'flow.relation.dashOffset': RelationSchema.shape.style.unwrap().shape.dashOffset,
