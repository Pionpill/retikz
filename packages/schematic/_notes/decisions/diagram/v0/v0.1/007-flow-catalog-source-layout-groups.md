...
- 状态：Accepted
- 决策日期：2026-09-04
- 关联：[Diagram v0.1 roadmap](./roadmap.md) · [Flow Source 模型与 LLM-first Authoring](./003-flow-source-model.md) · [Flow Layout Definition 与 Registry](./004-flow-layout-definition-registry.md) · [Flow Orchestration、Result 与 Artifact](./005-flow-orchestration-result-artifact.md) · [Schematic 制图能力域设计](../../../../../../../notes/architecture/schematic-design.md)
