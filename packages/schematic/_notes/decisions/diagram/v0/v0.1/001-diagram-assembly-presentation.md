...
本决策冻结所有具体 Diagram 类型可复用的 Presentation 内容契约、固定槽位、Legend 来源和统一输出边界。区域物理位置、外框、padding、section gap 与 Diagram appearance 由 ADR-002 确定；FlowDiagram 的 Graph Body、公共 Source root、adapter、自动 layout / routing、结果与 artifact 由同一 alpha.1 的后续 ADR 决定
