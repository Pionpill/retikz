...
- 状态：Accepted
- 决策日期：2026-09-12
- 关联：[所属 roadmap](../roadmap.md) · [Flow 平级 Source、Group 与 Layout](./07-flow-catalog-source-layout-groups.md) · [Flow Grid 二维对齐布局](./10-flow-grid-layout.md) · [Core Node 固定宽度与内容重排](../../../../../../../kernel/_notes/decisions/v0/v0.5/alpha.4/06-node-fixed-width.md) · [能力完备性](../../../../../architecture/schematic-graph-complete.md)
