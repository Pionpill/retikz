...
- 状态：Accepted
- 决策日期：2026-09-12
- 关联：[所属 roadmap](./roadmap.md) · [Layout 与 containment](./007-flow-catalog-source-layout-groups.md) · [布局扩展契约](./004-flow-layout-definition-registry.md) · [结果与 artifact](./005-flow-orchestration-result-artifact.md) · [Grid](./010-flow-grid-layout.md) · [能力完备性](../../../../architecture/schematic-graph-complete.md)
