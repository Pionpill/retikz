...
> 状态：进行中；alpha.1 已完成，ADR-01～10 均为 Accepted 或 Superseded，Graph / Group / Entity / Relation 四类 Source composite 已形成闭环；alpha.2 Block ADR 处于 Proposed。关联：[Graph v0 roadmap](../roadmap.md) · [Schematic Graph 完备设计](../../../../architecture/schematic-graph-complete.md)
...
| [alpha.2](./alpha.2/roadmap.md) | Structured Block               | 面向代码与工程结构图的 Header / Section / Row / Cell、Layout Flex item 复用、Section / Row Core Node endpoint 与三入口闭环                                                                    |
