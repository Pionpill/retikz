...
- 状态：Accepted
- 决策日期：2026-08-30
- 关联：[Graph v0.1 alpha.2 roadmap](./roadmap.md) · [被替代的固定结构决策](./011-block-composition.md) · [Block 整体宽度约束](./012-block-sizing.md) · [Schematic Graph 完备设计](../../../../architecture/schematic-graph-complete.md) · [Schematic 制图能力域设计](../../../../../../../notes/architecture/schematic-design.md) · [Group 通用包含与边界呈现](./010-group-composition.md)
...
- ADR-013 supersede ADR-011 的固定 grammar、内部 region host 与排除 `localNamespace` 决策；ADR-012 的外层 width / minWidth 契约继续有效
