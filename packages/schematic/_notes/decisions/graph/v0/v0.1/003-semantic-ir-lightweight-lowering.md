...
- 决策日期：2026-08-15
- 修订日期：2026-08-28
- 关联：[Graph package family](./001-graph-package-family.md) · [Entity 命名](./005-graph-element-naming.md) · [Entity contract](./007-entity-data-geometry.md) · [Relation contract](./008-relation-data-geometry.md) · [Graph context](./009-composable-graph-context.md) · [Group contract](./010-group-composition.md)
