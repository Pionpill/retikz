...
- 状态：Accepted
- 决策日期：2026-08-31
- 关联：[Graph v0.1 alpha.2 roadmap](./roadmap.md) · [Graph 语义注册与主题样式](./006-graph-entity-registry-theme.md) · [Block 开放内容与布局容器](./013-block-open-content.md) · [Schematic Graph 完备设计](../../../../architecture/schematic-graph-complete.md)
