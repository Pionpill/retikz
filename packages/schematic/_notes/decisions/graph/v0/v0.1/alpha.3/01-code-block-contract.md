# ADR-01：代码实体 Tier 3 与共享内容契约

- 状态：Proposed
- 决策日期：2026-09-08
- 关联：[roadmap](./roadmap.md) · [InterfaceBlock](./02-interface-block.md) · [FunctionBlock](./03-function-block.md) · [Block 开放内容](../alpha.2/03-block-open-content.md) · [通用视觉主题](../../../../../../../../notes/architecture/visual-theme-design.md)
