...
Graph v0.1 alpha.1 的 ADR-01～10 均已 Accepted。Vanilla 分别 normalize Graph、Group、Entity 与 Relation typed input；Group 只规范化任意 children，不创建成员集合、默认 id、自动布局、appearance 或 geometry wrapper。
