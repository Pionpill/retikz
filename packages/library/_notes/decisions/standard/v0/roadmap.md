...
> 图式语义后继：[Graph v0 roadmap](../../../../../diagram/_notes/decisions/graph/v0/roadmap.md) 独立演进；排版布局后继：[Layout v0 roadmap](../../layout/v0/roadmap.md) 独立演进；Standard 只保留跨领域绘图拓展能力
...
- alpha.3 曾验证逻辑图外壳、语义节点、连接与 Callout；这些图式元素现由 [Graph v0](../../../../../diagram/_notes/decisions/graph/v0/roadmap.md) 独立拥有，当前入口统一为 `GraphFrame`、`GraphNode` 与 `GraphConnector`
