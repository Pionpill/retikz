...
- 关联：[Standard v0.1 roadmap](./roadmap.md) · [ADR-016](./016-logic-diagram-profile.md) · [ADR-017](./017-headless-logic-frame.md)
- 后继：[Graph ADR-001](../../../../../../schematic/_notes/decisions/graph/v0/v0.1/001-graph-package-family.md) 已把四个 Core Node sugar 统一迁入 `GraphNode.role`；迁移不改变其 Core Node 等价语义
