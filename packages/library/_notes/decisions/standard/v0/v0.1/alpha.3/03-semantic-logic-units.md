...
- 后继：[Notation alpha.1 ADR-01](../../../../../../../diagram/_notes/decisions/notation/v0/v0.1/alpha.1/01-notation-package-family.md) 已提出把四个 Core Node sugar 迁入 Notation；迁移不改变本 ADR 的 Node 等价语义
