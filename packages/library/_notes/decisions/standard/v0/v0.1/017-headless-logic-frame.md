...
- 决策日期：2026-08-01
- 关联：[Standard v0.1 roadmap](./roadmap.md) · [ADR-016](./016-logic-diagram-profile.md) · [alpha.2 Box Layout](./roadmap.md) · [Core layout-aware composite](../../../../../../kernel/_notes/decisions/v0/v0.5/007-layout-aware-composite.md)
- 后继：[Graph ADR-001](../../../../../../schematic/_notes/decisions/graph/v0/v0.1/001-graph-package-family.md) 已把 GraphFrame 迁入 Graph，并继续复用 Layout 公共组合契约
