...
- 决策日期：2026-07-26
- 关联：[Standard v0.1 roadmap](./roadmap.md) · [alpha.1 roadmap](./roadmap.md) · [ADR-001](./001-grid-composite.md) · [ADR-002](./002-axes-composite.md) · [ADR-004](./004-frame-header-composition.md) · [Standard Drawing Library 设计](../../../../architecture/standard-library-design.md) · [Drawing Complete](../../../../../../kernel/_notes/architecture/core-drawing-complete.md)
...
本 ADR 保留 alpha.1 capability loading 的历史决策与验证记录，不再定义当前 Standard 的公开入口。当前直接 IR 与跨包 compile 接线以 [ADR-021](./021-direct-definition-loading.md) 为准；Standard 不再发布 capability module、bundle 或 preset 组合 API
