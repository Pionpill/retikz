...
- 状态：Accepted
- 决策日期：2026-08-04
- 关联：[Standard alpha.2 roadmap](./roadmap.md) · [ADR-014：通用 Legend](./014-generic-legend.md) · [Core ADR-020：Layout-aware Composite 的完整 Scope 输出契约](../../../../../../kernel/_notes/decisions/v0/v0.5/020-layout-aware-scope-output.md) · [Core ADR-019：Core 原子契约](../../../../../../kernel/_notes/decisions/v0/v0.5/019-core-atomic-contracts.md) · [Standard library design](../../../../architecture/standard-library-design.md) · [能力完备性与模块边界](../../../../../../../notes/architecture/capability-design.md)
- 协作边界：Legend 的排版组合 [Layout ADR-001](../../../layout/v0/v0.1/001-layout-package-family.md) 的 `/compose`，Axes / Grid / Frame / Legend 的 Standard presentation owner 不变
...
| layout / replay | [Core v0.5 ADR-017](../../../../../../kernel/_notes/decisions/v0/v0.5/017-layout-proposal-probe-contract.md) / [Core v0.5 ADR-020](../../../../../../kernel/_notes/decisions/v0/v0.5/020-layout-aware-scope-output.md) 与 Standard shared Box/Flex/Overlay contract | 不适用                                                                        | 不适用                                                                                         | 不适用                                                                 | `layoutChild()` 是唯一测量入口，`replay()` 是唯一 placement 提交入口，`context.scope()` 只承载 authored Scope 与 allocation Scope |
