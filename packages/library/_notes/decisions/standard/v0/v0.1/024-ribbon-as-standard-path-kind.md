...
- 相同 key 的不同 Ribbon Path Kind definitions 由 ADR-023 assembly / Core path-kind registry fail-loud；不允许 Standard 官方 definition 静默覆盖用户 definition
