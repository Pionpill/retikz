...
> 状态：进行中；ADR-01～07 已 Accepted，ADR-08 已由 Kernel ADR-12 取代，ADR-09～10 Proposed，alpha.2 为 Layout Inspector 可选子入口迁移、通用 Legend 与 Presentation lower reuse 收口重新打开
>
