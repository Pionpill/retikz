...
- 决策日期：2026-07-30
- 关联：[alpha.2 roadmap](./roadmap.md) · [Standard v0.1 roadmap](./roadmap.md) · [Core ADR-017](../../../../../../kernel/_notes/decisions/v0/v0.5/017-layout-proposal-probe-contract.md) · [Drawing Complete](../../../../../../kernel/_notes/architecture/core-drawing-complete.md)
...
[Core v0.5 ADR-017](../../../../../../kernel/_notes/decisions/v0/v0.5/017-layout-proposal-probe-contract.md) 已提供双轴 proposal、`layoutChild()` probe、`slotSize`、真实 allocation/visual bounds、alignment guides、failure isolation 和 one-use replay。Standard 不再设计第二套测量合同；本 ADR 冻结 Standard 对该公开合同的解释。
...
- Standard 必须保持 [Core v0.5 ADR-017](../../../../../../kernel/_notes/decisions/v0/v0.5/017-layout-proposal-probe-contract.md) 冻结的 proposal、`slotSize`、allocation/visual bounds 与 replay 契约不变
