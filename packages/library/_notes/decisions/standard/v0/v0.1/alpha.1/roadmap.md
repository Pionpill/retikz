...
>
> 主题：初始化 Standard 包家族、迁移首批宿主无关 Tier 2 composite，并建立统一 capability loading
...
- capability module、不可变 bundle、显式 all preset 与 Vanilla 全量 adapters 已接入同一 Core registry 路径
- 双语组件页、迁移指引、capability loading 扩展页与 Standard v0.1 changelog 已同步

## Gate

- [x] ADR-01～05 已完成 Architecture Gate 或人工裁决，最终生效决策均为 Accepted
