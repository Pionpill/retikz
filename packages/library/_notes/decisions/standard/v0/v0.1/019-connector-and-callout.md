...
- 决策日期：2026-08-01
- 关联：[Standard v0.1 roadmap](./roadmap.md) · [ADR-016](./016-logic-diagram-profile.md) · [ADR-017](./017-headless-logic-frame.md) · [ADR-018](./018-semantic-logic-units.md) · [Core Path contract](../../../../../../kernel/_notes/decisions/v0/v0.5/roadmap.md)
- 后继：[Graph ADR-001](../../../../../../schematic/_notes/decisions/graph/v0/v0.1/001-graph-package-family.md) 已把连接语义统一迁入 `GraphConnector`，并保留 Core Path / target 主链；Callout 后续已由 Graph alpha.3 撤回
