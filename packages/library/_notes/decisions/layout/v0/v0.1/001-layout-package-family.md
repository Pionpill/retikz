...
| 能力                  | 被继承的决策                                                                                                                                                                   |
| --------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| Layout Profile        | [Standard ADR-006](../../../standard/v0/v0.1/006-layout-profile-core-gate.md)                                                                                                  |
| Box 与 LayoutItem     | [Standard ADR-007](../../../standard/v0/v0.1/007-box-layout-item-vocabulary.md)                                                                                                |
| Flex / Grid / Overlay | [ADR-008](../../../standard/v0/v0.1/008-flex-layout.md) · [ADR-009](../../../standard/v0/v0.1/009-grid-layout.md) · [ADR-010](../../../standard/v0/v0.1/010-overlay-layout.md) |
