...
- [`decisions/standard/v0/v0.1/alpha.2/roadmap.md`](./decisions/standard/v0/v0.1/alpha.2/roadmap.md)：通用 Box Layout 规划
- [`decisions/standard/v0/v0.1/alpha.3/roadmap.md`](./decisions/standard/v0/v0.1/alpha.3/roadmap.md)：Plot / Table / 直接作者复用的通用 Legend 规划
