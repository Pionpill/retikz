...
/** 将 Standard target 映射为 Core Path 可解析的 target，并拒绝尚未接通的 section target */
...
/** Standard Connector lightweight expansion definition */
export const ConnectorDefinition: ExpandCompositeDefinition<IRConnector, typeof STANDARD_NAMESPACE, 'connector'> =
  defineComposite({
