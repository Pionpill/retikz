...
import type { LogicFrameInput, LogicFrameRegionInput, LogicFrameSectionInput } from '@retikz/standard';
import type { FC, ReactNode } from 'react';

import { createLogicFrame, LogicFrameDefinition } from '@retikz/standard';
import { Children, Fragment, isValidElement } from 'react';

import type { StandardEmbeddableComponent } from '../shared';

import { StandardLogicFrameReactNamespace } from '../shared';
...
const logicFrameEmbeddableAdapter: EmbeddableTier2Adapter<LogicFrameProps> = {
  ...
  namespace: StandardLogicFrameReactNamespace,
  contribute: props => {
...
/** 将 Standard LogicFrame 接入 React 编写流程的组件 */
export const LogicFrame = LogicFrameComponent as StandardEmbeddableComponent<LogicFrameProps>;
