...
import type { FlexLayoutItemInput, GridLayoutItemInput, OverlayLayoutItemInput } from '@retikz/standard';
...
const LayoutItemComponent: FC<LayoutItemProps> = () => {
  throw new Error('Standard LayoutItem must be a direct child of FlexLayout, GridLayout, or OverlayLayout');
};

/** 只由 Standard 布局容器静态读取的语义 item 组件 */
