...
状态：Accepted
决策日期：2026-06-22
关联：[plot v0.1-alpha.12 roadmap](./roadmap.md) · [ADR-066 channel registry](./066-channel-registry.md) · [ADR-067 custom visual channel](./067-custom-visual-channel.md)

## 背景

ADR-066/067 已经把 visual channel registry 与自定义 delivery 打通，contract 也区分了 Position、Mark、Scope、Node、Path 等落点。但内置 provider 主要覆盖 mark / node / position，path / scope 仍缺少系统化覆盖。
