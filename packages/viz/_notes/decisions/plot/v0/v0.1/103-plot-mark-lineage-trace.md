...
- 决策日期：2026-07-08
- 完成日期：2026-07-08
- 关联：[plot v0.1 roadmap](./roadmap.md) · [data ADR-004](../../../data/v0/v0.1/004-data-lineage-trace.md) · [plot ADR-101](./101-data-package-adapter.md) · [plot-design.md §3.3 Transform / §8 lowering](../../../../architecture/plot-design.md)
