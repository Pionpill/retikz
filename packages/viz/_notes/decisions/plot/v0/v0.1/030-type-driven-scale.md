...
- 状态：Accepted
- 决策日期：2026-06-07
- 关联：[plot v0.1-alpha.6 待办](./roadmap.md) · [plot v0 roadmap 阶段二](../roadmap.md) · [plot-design §3.4 Scale / §3.5 Coordinate / §3.9 Guide](../../../../architecture/plot-design.md) · 依赖：[ADR-028 数据模型类型层](./028-data-model.md) · 关联：[ADR-029 可移植契约](./029-data-portability.md)
