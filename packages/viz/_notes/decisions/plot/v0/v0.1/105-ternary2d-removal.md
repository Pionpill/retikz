...
- 状态：Accepted
- 决策日期：2026-07-27
- 关联：[plot v0.1-beta.2 roadmap](./roadmap.md) · [Visualization Complete](../../../../architecture/plot-visualization-complete.md) · 被替代：[ADR-047](./047-ternary2d.md) / [ADR-048](./048-dsl-docs.md)
