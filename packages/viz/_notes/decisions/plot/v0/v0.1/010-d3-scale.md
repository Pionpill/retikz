...
- 状态：Accepted
- 决策日期：2026-06-04
- 关联：[plot v0.1-alpha.2 待办](./roadmap.md) · [plot v0.1 roadmap](./roadmap.md) · [plot-design.md §3.5 scale / §3.9 guide / §13（plot 可拉 d3-scale）](../../../../architecture/plot-design.md) · 回溯：[ADR-006 lowerPlots](./006-plot-lowering.md) · 消费方：[ADR-011 布局](./011-plot-area-layout.md) · [ADR-012 guide lowering](./012-guide-lowering.md)
...
- **刻度怎么画（轴线 / tick / label）与位置（plot area）** → [ADR-012](./012-guide-lowering.md) / [ADR-011](./011-plot-area-layout.md)。
