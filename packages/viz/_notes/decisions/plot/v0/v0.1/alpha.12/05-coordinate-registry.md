...
v0.1 stable 的内置坐标集合为 `cartesian2D`、`polar2D`、`cartesian1D` 与 `polar1D`。`ternary2D` 已由 [beta.2 ADR-03](../beta.2/03-ternary2d-removal.md) 移除；三角色及其它特殊投影继续通过同一 `CoordinateDefinition` 扩展路径表达。
