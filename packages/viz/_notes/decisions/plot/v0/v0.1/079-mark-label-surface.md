...
- 决策日期：2026-06-28
- Owner：plot
- 关联：[plot v0.1-alpha.13 roadmap](./roadmap.md) · [kernel ADR-018](../../../../../../kernel/_notes/decisions/v0/v0.4/018-node-label-inside-placement.md) · [kernel ADR-019](../../../../../../kernel/_notes/decisions/v0/v0.4/019-ribbon-label.md)
