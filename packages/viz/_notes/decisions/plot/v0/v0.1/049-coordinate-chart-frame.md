...
- 决策日期：2026-06-09
- 取代日期：2026-06-18
- 取代者：[ADR-061：coordinate registry](./061-coordinate-registry.md)
...
因此，本 ADR 关于局部轴标架的几何判断仍有效，但其 custom operation、工厂注入与公开 API 方案已整体由 v0.1 ADR-061 取代。当前契约以 coordinate registry、代码与文档站为准。
