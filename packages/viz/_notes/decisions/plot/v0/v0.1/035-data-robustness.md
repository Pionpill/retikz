...
- 状态：Superseded
- 替代：[Data ADR-001](../../../data/v0/v0.1/001-plot-data-migration.md)；数据归一化与非法值策略现由 `@retikz/data` pipeline 承接
- 决策日期：2026-06-07
- 关联：[plot v0.1-alpha.6 roadmap](./roadmap.md) · 本里程碑 [ADR-028 数据模型](./028-data-model.md) / [ADR-029 可移植契约](./029-data-portability.md)（coercion / validateData）/ [ADR-031 resolveField](./031-field-resolver.md)
