...
> 状态：Done（2026-07-07 收尾） · 完成提交：`21b1019e` / `23bba402` / `22ceb713` · 关联：[plot v0.1 roadmap](../roadmap.md) · [data beta.1 迁移](../../../../data/v0/v0.1/beta.1/roadmap.md)
...
- [ADR-01：适配 @retikz/data 数据层](./01-data-package-adapter.md) — Accepted（已压缩）
- [ADR-02：plot 自行注册 plot-only transform](./02-plot-transform-registration.md) — Accepted（已压缩）
