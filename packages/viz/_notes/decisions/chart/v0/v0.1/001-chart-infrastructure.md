...
- 决策日期：2026-07-31
- 关联：[alpha.1 roadmap](./roadmap.md) · [ADR-003](./003-presentation-standard-layout.md) · [Chart 总设计](../../../../architecture/chart-design.md)
...
typed recipe 基础仍由本 ADR拥有；基础 Chart、canonical `IRChart`、单一 `chart.chart` root 和公开 authoring 统一由 [ADR-003](./003-presentation-standard-layout.md) 取代，避免两套 Chart root contract 并存。
