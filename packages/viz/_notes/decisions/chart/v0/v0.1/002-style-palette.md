...
- 决策日期：2026-08-07
- 关联：[alpha.1 roadmap](./roadmap.md) · [Chart 基础设施 ADR-001](./001-chart-infrastructure.md) · [Chart authoring ADR-003](./003-presentation-standard-layout.md) · [Plot 主题 ADR-001](../../../plot/v0/v0.2/001-chart-layering.md) · [Plot inherited theme token ADR-002](../../../plot/v0/v0.2/002-inherited-theme-token-scope.md)
- Supersedes：[Core v0.5 ADR-024](../../../../../../kernel/_notes/decisions/v0/v0.5/024-lightweight-theme-resolution.md) 已取代 [Core v0.5 ADR-022](../../../../../../kernel/_notes/decisions/v0/v0.5/022-theme-token-namespace-context.md) 的持久化 namespace bag、Theme token Definition / Contribution 与 Core token registry；本文采用轻量 selector、owner-local style definition 与本地 token 输入
...
Chart 不再重复拥有 Plot surface、guide、label 或 palette 的 token vocabulary。本 ADR 也替代 ADR-001 中“全部 variant 共享 forwarded `theme`”的字段表述：公开字段改为 `plotThemeTokens`、`colors` 与 `plotTheme`，旧 `theme` 不属于 IRChart contract。
