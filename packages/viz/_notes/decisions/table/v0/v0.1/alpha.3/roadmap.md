...
| [05](./05-style-preset-and-token-resolution.md)            | Table style preset、`tableThemeTokens`、shared categorical projection 与 precedence | Core ADR-13、ADR-02～04；与 ADR-04 原子实施               | Proposed |
