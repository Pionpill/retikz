...
- 决策日期：2026-07-23
- 收口日期：2026-07-27
- 关联：[alpha.2 roadmap](./roadmap.md) · [Cell box 与 span](./011-cell-box-span-and-alignment.md) · [layout lowering 与 manifest](./014-layout-lowering-manifest-and-migration.md)
...
fit 在选定 replay root 外层施加 finite numeric scale，再按 ADR-011 用缩放后的 allocation bounds 对齐 content box：
