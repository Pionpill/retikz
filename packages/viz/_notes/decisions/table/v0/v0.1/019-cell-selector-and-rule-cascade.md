...
- 状态：Proposed
- 决策日期：2026-07-31
- 关联：[alpha.3 roadmap](./roadmap.md) · [ADR-017 formatter](./017-cell-formatter-and-formatted-value.md) · [ADR-018 appearance](./018-presentation-context-and-cell-appearance.md) · [Table 总设计](../../../../architecture/table-design.md)
...
alpha.3 的完整优先级由 ADR-020/021 补齐，本 ADR 冻结其稳定骨架：
