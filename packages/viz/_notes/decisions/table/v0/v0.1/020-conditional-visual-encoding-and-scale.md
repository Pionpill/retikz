...
- 状态：Proposed
- 决策日期：2026-07-31
- 关联：[alpha.3 roadmap](./roadmap.md) · [ADR-018 appearance](./018-presentation-context-and-cell-appearance.md) · [ADR-019 selector/rule](./019-cell-selector-and-rule-cascade.md) · [ADR-021 style tokens](./021-style-preset-and-token-resolution.md) · [Table 完备设计](../../../../architecture/table-visualization-complete.md)
