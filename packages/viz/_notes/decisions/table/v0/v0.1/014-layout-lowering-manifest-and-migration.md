...
- 决策日期：2026-07-23
- 收口日期：2026-07-27
- 关联：[alpha.2 roadmap](./roadmap.md) · [Core constrained layout gate](./009-core-constrained-layout-gate.md) · [Cell box](./011-cell-box-span-and-alignment.md) · [content policy](./012-content-fit-overflow-and-wrap.md) · [Border Graph](./013-border-graph-and-conflict-resolution.md)
