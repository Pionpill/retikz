...
- 决策日期：2026-08-07
- 关联：[alpha.3 roadmap](./roadmap.md) · [ADR-018 presentation](./018-presentation-context-and-cell-appearance.md) · [ADR-019 rules](./019-cell-selector-and-rule-cascade.md) · [ADR-020 visual encoding](./020-conditional-visual-encoding-and-scale.md) · [Core ADR-022：Theme Token Namespace Context 与共享颜色](../../../../../../kernel/_notes/decisions/v0/v0.5/022-theme-token-namespace-context.md) · [Table 表格可视化完备设计](../../../../architecture/table-visualization-complete.md)
- Superseded in part by：[Core ADR-024：轻量 Theme IR 与可扩展 Style 解析](../../../../../../kernel/_notes/decisions/v0/v0.5/024-lightweight-theme-resolution.md) 已移除持久化 namespace bag、Theme token Definition / Contribution 与 Core token registry。本文保留 Table token owner、shared categorical projection、本地覆盖、级联和最终消费决策
...
以下早期 Theme token Definition / Contribution 形态已被 [Core v0.5 ADR-024](../../../../../../kernel/_notes/decisions/v0/v0.5/024-lightweight-theme-resolution.md) supersede：
