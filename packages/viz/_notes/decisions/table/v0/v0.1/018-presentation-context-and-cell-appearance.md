...
- 状态：Proposed
- 决策日期：2026-07-31
- 关联：[alpha.3 roadmap](./roadmap.md) · [ADR-017 formatter](./017-cell-formatter-and-formatted-value.md) · [alpha.1 Cell presentation](./003-cell-presentation.md) · [Table 完备设计](../../../../architecture/table-visualization-complete.md)
...
- `context` 是 ADR-017 的最小 Cell identity/source
