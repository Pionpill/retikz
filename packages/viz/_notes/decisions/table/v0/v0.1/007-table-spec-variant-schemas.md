...
- 状态：Accepted
- 决策日期：2026-07-21
- 关联：[table v0.1 roadmap](./roadmap.md) · [Table 完备设计](../../../../architecture/table-visualization-complete.md) · [Table 总设计](../../../../architecture/table-design.md) · [ADR-001](./001-table-spec-root.md) · [ADR-002](./002-table-structure-model.md) · [ADR-006](./006-table-bindings.md)
