...
| [alpha.3](./alpha.3/roadmap.md) | **Authoring 与呈现语法** | manual row-major persistence、formatter、presentation、selector/rule、条件视觉 scale、theme/legend | alpha.2 canonical model 与既有 registry 边界 | 进行中     |
