...
| [alpha.3](./alpha.3/roadmap.md) | **呈现语法**                   | formatter、presentation、selector/rule、条件视觉 scale、theme、Legend descriptor / Standard Legend 消费 | alpha.2 canonical model 与既有 registry 边界；Standard alpha.3 | 设计中 |
