...
- [`../../../../../apps/docs/src/modules/docs/components/component-preview/theme/presets/plot.ts`](../../../../../apps/docs/src/modules/docs/components/component-preview/theme/presets/plot.ts)：docs 参考 Clean Light / Dark 的稀疏 token definition，其余值来自 mode 默认 preset
