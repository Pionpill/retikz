...
- 闭合 Table theme token 不建立 Definition / registry；内置 style baseline、Core 继承颜色与 local `tableThemeTokens` 必须经过同一 strict schema、leaf resolver 与消费链路，未知 token fail-loud
