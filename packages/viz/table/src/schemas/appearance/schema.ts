...
export const TableCellBackgroundSchema = z
  .strictObject({
    fill: PaintValueSchema.describe('Paint filling the Table Cell box.'),
    fillOpacity: ScopeSchema.shape.fillOpacity.describe(
      'Cell background fill opacity. Omitted fields use 1 at runtime.',
    ),
  })
  .describe('Background painted inside a resolved Table Cell box.');

export const TableCellContentStyleSchema = z
  .strictObject({
...
export const TableCellAppearanceSchema = z
  .strictObject({
