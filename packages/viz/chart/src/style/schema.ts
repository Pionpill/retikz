...
export const ChartThemeTokenFieldShape = {
  ...
  [ChartThemeToken.ChartCaptionForeground]: CssColorSchema.describe('Chart caption foreground color'),
  [ChartThemeToken.ChartCaptionFontSize]: FontSizeSchema.describe('Chart caption font size'),
  [ChartThemeToken.ChartCaptionFontWeight]: FontWeightSchema.describe('Chart caption font weight'),
  [ChartThemeToken.ChartCaptionLineHeight]: LineHeightSchema.describe('Chart caption line height'),
  [ChartThemeToken.ChartCaptionAlign]: TextAlignSchema.describe('Chart caption text alignment'),
  ...
  [ChartThemeToken.ChartCreditForeground]: CssColorSchema.describe('Chart credit foreground color'),
  [ChartThemeToken.ChartCreditFontSize]: FontSizeSchema.describe('Chart credit font size'),
  [ChartThemeToken.ChartCreditFontWeight]: FontWeightSchema.describe('Chart credit font weight'),
  [ChartThemeToken.ChartCreditLineHeight]: LineHeightSchema.describe('Chart credit line height'),
  [ChartThemeToken.ChartCreditAlign]: TextAlignSchema.describe('Chart credit text alignment'),
