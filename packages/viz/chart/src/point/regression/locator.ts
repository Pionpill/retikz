...
/** 为 Regression 的固定 composition identity 补全 Chart locator 条件 */
export const qualifyRegressionChartLocatorOptions = (options: ChartLocatorOptions): PlotLocatorOptions =>
  qualifyChartLocatorOptions(options, {
    facet: pointRecipeId(ChartType.Regression, 'composition.facet'),
  });
