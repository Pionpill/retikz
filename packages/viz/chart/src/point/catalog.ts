import type { AnyChartRecipe, ChartRecipe, InternalChartBound } from './recipe';
...
export const chartRecipeOf = <TVariant extends InternalChartBound>(recipe: ChartRecipe<TVariant>): AnyChartRecipe => ({
  type: recipe.type,
  bind: input => {
