...
import type { IRBubbleChartSpec, IRScatterChartSpec } from '../../schemas';
import type { ChartPatchChange, ChartRecipeSeed, ChartRecipeStyleContext } from './types';

import { ChartInspectionMemberKind } from '../../schemas';
...
/** 把 Point Chart patch 转成 merge pipeline 的逐叶 change */
