...
- **拥有的契约**：未来的 `<Table>` 与相关 React props / components、children → TableSpec 的纯 authoring builder、dataset / registry 注入、React runtime 接线，以及后续虚拟滚动的 viewport / scroll host 接线
