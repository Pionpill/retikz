...
| `@retikz/chart`         | 把封闭 Chart 类型解析为完整 IRPlot   | Chart schema fragments、recipe、Chart style definition / canvas / presentation / recipe token、Plot style option 转发、inspection、逐类型 composite  | Plot token / preset / resolver、Data / Plot 算法、Standard layout、Core 编译、adapter、renderer                                |
