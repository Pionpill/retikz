...
const NonBlankRecordKeySchema = z.record(NonBlankStringSchema, z.unknown());

const PositionEncodingObjectSchema = z
  .object({
...
export const MarkChannelEncodingSchema = z
  .object({
    ...
    channels: z
      .record(NonBlankStringSchema, ChannelSchema)
      .optional()
      .describe(
