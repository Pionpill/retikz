...
export const PlotAxisThemeTokenRuleSchema = z
  .strictObject({
...
export const PlotAxisThemeTokenRulesSchema = z
  .array(PlotAxisThemeTokenRuleSchema)
  .describe('Ordered Plot Axis theme token rules');
