      ...
      marks: [
        {
          ...
          scale: { kind: 'constant', value: 1.1 },
          xScale: { kind: 'constant', value: 1.2 },
          yScale: { kind: 'constant', value: 0.9 },
          innerXSep: { kind: 'constant', value: 3 },
          innerYSep: { kind: 'constant', value: 5 },
          outerSep: { kind: 'constant', value: 2 },
          margin: { kind: 'constant', value: 1 },
