...
export type InputPathMark = PathMarkProps;
export type InputPointMark = PointMarkProps;
export type InputIntervalMark = IntervalMarkProps;
export type InputReferenceMark = ReferenceMarkProps;
export type InputRelationMark = RelationMarkProps;
export type InputFieldName = FieldName;
export type InputExtensionChannel = ExtensionChannelProp;
export type InputCoreNodeChannels = CoreNodeChannelProps;
export type InputCorePathChannels = CorePathChannelProps;
export type InputDatumLabel = DatumLabelProps;
