...
import type { ArrowConfig, ArrowProps, DrawPointType, DrawWaySegmentType, DrawWayType } from './types';
...
const InnerDraw = forwardRef<SVGPathElement, InnerDrawProps>((props, ref) => {
  ...
  const waySegments = useMemo(() => {
    ...
    const segments: Array<Array<DrawWayType>> = [];
    let waySegment: Array<DrawWayType> = [];
    ...
    return segments as Array<DrawWaySegmentType>;
  }, [way]);
