...
import type NodeModel from '../../../model/component/node';
...
import type { DrawWaySegmentType, VerticalDrawPosition } from '../types';
          ...
          switch (type) {
            ...
            case 'vertical': {
              ...
              if (Array.isArray(verPosition[0])) {
                const realVerPosition = verPosition as Array<Position>;
