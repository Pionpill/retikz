...
> 状态：Accepted；v0.1 alpha.1 与 alpha.2 已完成。关联：[Diagram Notation 完备设计](../../../architecture/diagram-notation-complete.md) · [Diagram 制图能力域设计](../../../../../../notes/architecture/diagram-design.md)
