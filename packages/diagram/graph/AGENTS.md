...
本文件覆盖 `packages/diagram/graph/`。全仓通用规则见根 [`AGENTS.md`](../../../AGENTS.md)，Diagram 分组规则见 [`../AGENTS.md`](../AGENTS.md)。涉及 Diagram 能力归属时先读 [`Diagram 制图能力域设计`](../../../notes/architecture/diagram-design.md) 与 [`Diagram Graph 完备设计`](../_notes/architecture/diagram-graph-complete.md)。
