...
export const Plot: FC<PlotProps> = props => {
  const { width, height, className, style, renderer, fontSize, margin, provenance, datumProvenance, datumIdField, fieldMaps, validateData, resolveField } = props;
  ...
  return (
    <Layout
      ...
      composites={lowerPlots(datasets, { width, height, fontSize, margin, provenance, datumProvenance, datumIdField, fieldMaps: effectiveFieldMaps, validateData, resolveField })}
      width={width}
      height={height}
      className={className}
      style={style}
