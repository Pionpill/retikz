 ...
 */
export const VALID_GUIDE_DIMENSIONS: Record<Exclude<CoordinateType, 'custom'>, ReadonlyArray<string>> = {
 ...
 */
export const REQUIRED_POSITION_CHANNELS: Record<Exclude<CoordinateType, 'custom'>, ReadonlyArray<'x' | 'y' | 'a' | 'b' | 'c'>> = {
  [PlotCoordinate.Cartesian2D]: ['x', 'y'],
