...
import { DEFAULT_FILL, colorGroupedScope, constantNodeStyleOverrides } from './shared';
...
export const styleForGeometry = (kind: CellGeometry['kind'], mark: Mark): ((fill: string) => IRNodeDefault) => {
